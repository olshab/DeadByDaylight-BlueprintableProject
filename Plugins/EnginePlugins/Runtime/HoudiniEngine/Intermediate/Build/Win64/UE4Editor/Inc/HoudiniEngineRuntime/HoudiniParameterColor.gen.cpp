...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UHoudiniParameterColor_Statics::NewProp_Color_MetaData[] = {
		{ "Category", "HoudiniParameterColor" },
		{ "ModuleRelativePath", "Public/HoudiniParameterColor.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UHoudiniParameterColor_Statics::NewProp_Color = { "Color", nullptr, (EPropertyFlags)0x0020080000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniParameterColor, Color), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(Z_Construct_UClass_UHoudiniParameterColor_Statics::NewProp_Color_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniParameterColor_Statics::NewProp_Color_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UHoudiniParameterColor, 764719454);
