...
static struct FScriptStruct_BHVRAnalytics_StaticRegisterNativesFBaseSingleStructIndexAnalytics
{
	...
	{
		UScriptStruct::DeferCppStructOps<FBaseSingleStructIndexAnalytics>(FName(TEXT("BaseSingleStructIndexAnalytics")));
	}
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FBaseSingleStructIndexAnalytics_Statics::NewProp_SessionGuid_MetaData[] = {
		{ "Category", "BaseSingleStructIndexAnalytics" },
		{ "ModuleRelativePath", "Public/BaseSingleStructIndexAnalytics.h" },
	};
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FBaseSingleStructIndexAnalytics_Statics::NewProp_SessionGuid = { "SessionGuid", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBaseSingleStructIndexAnalytics, SessionGuid), METADATA_PARAMS(Z_Construct_UScriptStruct_FBaseSingleStructIndexAnalytics_Statics::NewProp_SessionGuid_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBaseSingleStructIndexAnalytics_Statics::NewProp_SessionGuid_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FBaseSingleStructIndexAnalytics_Hash() { return 4133678636U; }
