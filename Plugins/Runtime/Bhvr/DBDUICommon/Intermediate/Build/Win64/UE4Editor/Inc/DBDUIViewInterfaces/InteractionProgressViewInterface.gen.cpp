...
// End Cross Module References
	...
	DEFINE_FUNCTION(IInteractionProgressViewInterface::execPlayHemorrhageAnimation)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->PlayHemorrhageAnimation_Implementation();
		P_NATIVE_END;
	}
	...
	DEFINE_FUNCTION(IInteractionProgressViewInterface::execUpdateInputProgress)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->UpdateInputProgress_Implementation(Z_Param_progress,Z_Param_itemCharge,Z_Param_isBlocked);
		P_NATIVE_END;
	}
	...
	{
		check(0 && "Do not directly call Event functions in Interfaces. Call Execute_PlayHemorrhageAnimation instead.");
	}
	...
	void IInteractionProgressViewInterface::UpdateInputProgress(const float progress, const float itemCharge, bool isBlocked)
	{
	...
	void UInteractionProgressViewInterface::StaticRegisterNativesUInteractionProgressViewInterface()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "PlayHemorrhageAnimation", &IInteractionProgressViewInterface::execPlayHemorrhageAnimation },
	...
	struct Z_Construct_UFunction_UInteractionProgressViewInterface_PlayHemorrhageAnimation_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UInteractionProgressViewInterface_PlayHemorrhageAnimation_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/InteractionProgressViewInterface.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UInteractionProgressViewInterface_PlayHemorrhageAnimation_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UInteractionProgressViewInterface, nullptr, "PlayHemorrhageAnimation", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UInteractionProgressViewInterface_PlayHemorrhageAnimation_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UInteractionProgressViewInterface_PlayHemorrhageAnimation_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UInteractionProgressViewInterface_PlayHemorrhageAnimation()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UInteractionProgressViewInterface_PlayHemorrhageAnimation_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	void Z_Construct_UFunction_UInteractionProgressViewInterface_UpdateInputProgress_Statics::NewProp_isBlocked_SetBit(void* Obj)
	{
		((InteractionProgressViewInterface_eventUpdateInputProgress_Parms*)Obj)->isBlocked = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UInteractionProgressViewInterface_UpdateInputProgress_Statics::NewProp_isBlocked = { "isBlocked", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(InteractionProgressViewInterface_eventUpdateInputProgress_Parms), &Z_Construct_UFunction_UInteractionProgressViewInterface_UpdateInputProgress_Statics::NewProp_isBlocked_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UInteractionProgressViewInterface_UpdateInputProgress_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UInteractionProgressViewInterface_UpdateInputProgress_Statics::NewProp_isBlocked,
	};
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UInteractionProgressViewInterface_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UInteractionProgressViewInterface_PlayHemorrhageAnimation, "PlayHemorrhageAnimation" }, // 898097231
		{ &Z_Construct_UFunction_UInteractionProgressViewInterface_SetInputProgressPrompt, "SetInputProgressPrompt" }, // 4243121601
		{ &Z_Construct_UFunction_UInteractionProgressViewInterface_UpdateInputProgress, "UpdateInputProgress" }, // 1919732302
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UInteractionProgressViewInterface, 1176833391);
	...
	static FName NAME_UInteractionProgressViewInterface_PlayHemorrhageAnimation = FName(TEXT("PlayHemorrhageAnimation"));
	void IInteractionProgressViewInterface::Execute_PlayHemorrhageAnimation(UObject* O)
	{
		check(O != NULL);
		check(O->GetClass()->ImplementsInterface(UInteractionProgressViewInterface::StaticClass()));
		UFunction* const Func = O->FindFunction(NAME_UInteractionProgressViewInterface_PlayHemorrhageAnimation);
		if (Func)
		{
			O->ProcessEvent(Func, NULL);
		}
		...
		{
			I->PlayHemorrhageAnimation_Implementation();
		}
	}
	...
	void IInteractionProgressViewInterface::Execute_UpdateInputProgress(UObject* O, const float progress, const float itemCharge, bool isBlocked)
	{
		check(O != NULL);
		check(O->GetClass()->ImplementsInterface(UInteractionProgressViewInterface::StaticClass()));
		...
		{
			I->UpdateInputProgress_Implementation(progress,itemCharge,isBlocked);
		}
	}
