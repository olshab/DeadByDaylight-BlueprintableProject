...
static struct FScriptStruct_DBDUIViewInterfaces_StaticRegisterNativesFInteractionProgressViewData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FInteractionProgressViewData>(FName(TEXT("InteractionProgressViewData")));
	}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_PermanentProgress_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_PermanentProgress;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FInteractionProgressViewData_Statics::NewProp_PermanentProgress_MetaData[] = {
		{ "Category", "InteractionProgressViewData" },
		{ "ModuleRelativePath", "Public/InteractionProgressViewData.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FInteractionProgressViewData_Statics::NewProp_PermanentProgress = { "PermanentProgress", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FInteractionProgressViewData, PermanentProgress), METADATA_PARAMS(Z_Construct_UScriptStruct_FInteractionProgressViewData_Statics::NewProp_PermanentProgress_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInteractionProgressViewData_Statics::NewProp_PermanentProgress_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FInteractionProgressViewData_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FInteractionProgressViewData_Statics::NewProp_PermanentProgress,
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FInteractionProgressViewData_Hash() { return 2975060802U; }
