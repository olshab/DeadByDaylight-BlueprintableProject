...
static_assert(std::is_polymorphic<FItemViewData>() == std::is_polymorphic<FBaseLoadoutPartViewData>(), "USTRUCT FItemViewData cannot be polymorphic unless super FBaseLoadoutPartViewData is polymorphic");
...
static struct FScriptStruct_DBDUIViewInterfaces_StaticRegisterNativesFItemViewData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FItemViewData>(FName(TEXT("ItemViewData")));
	}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_IsAvailable_MetaData[];
#endif
		static void NewProp_IsAvailable_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_IsAvailable;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_IsSpecialItem_MetaData[];
#endif
		static void NewProp_IsSpecialItem_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_IsSpecialItem;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_IsCursedItem_MetaData[];
#endif
		static void NewProp_IsCursedItem_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_IsCursedItem;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FItemViewData_Statics::NewProp_IsAvailable_MetaData[] = {
		{ "Category", "ItemViewData" },
		{ "ModuleRelativePath", "Public/ItemViewData.h" },
	};
#endif
	void Z_Construct_UScriptStruct_FItemViewData_Statics::NewProp_IsAvailable_SetBit(void* Obj)
	{
		((FItemViewData*)Obj)->IsAvailable = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FItemViewData_Statics::NewProp_IsAvailable = { "IsAvailable", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FItemViewData), &Z_Construct_UScriptStruct_FItemViewData_Statics::NewProp_IsAvailable_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FItemViewData_Statics::NewProp_IsAvailable_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FItemViewData_Statics::NewProp_IsAvailable_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FItemViewData_Statics::NewProp_IsSpecialItem_MetaData[] = {
		{ "Category", "ItemViewData" },
		{ "ModuleRelativePath", "Public/ItemViewData.h" },
	};
#endif
	void Z_Construct_UScriptStruct_FItemViewData_Statics::NewProp_IsSpecialItem_SetBit(void* Obj)
	{
		((FItemViewData*)Obj)->IsSpecialItem = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FItemViewData_Statics::NewProp_IsSpecialItem = { "IsSpecialItem", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FItemViewData), &Z_Construct_UScriptStruct_FItemViewData_Statics::NewProp_IsSpecialItem_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FItemViewData_Statics::NewProp_IsSpecialItem_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FItemViewData_Statics::NewProp_IsSpecialItem_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FItemViewData_Statics::NewProp_IsCursedItem_MetaData[] = {
		{ "Category", "ItemViewData" },
		{ "ModuleRelativePath", "Public/ItemViewData.h" },
	};
#endif
	void Z_Construct_UScriptStruct_FItemViewData_Statics::NewProp_IsCursedItem_SetBit(void* Obj)
	{
		((FItemViewData*)Obj)->IsCursedItem = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FItemViewData_Statics::NewProp_IsCursedItem = { "IsCursedItem", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FItemViewData), &Z_Construct_UScriptStruct_FItemViewData_Statics::NewProp_IsCursedItem_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FItemViewData_Statics::NewProp_IsCursedItem_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FItemViewData_Statics::NewProp_IsCursedItem_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FItemViewData_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FItemViewData_Statics::NewProp_IsAvailable,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FItemViewData_Statics::NewProp_IsSpecialItem,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FItemViewData_Statics::NewProp_IsCursedItem,
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FItemViewData_Hash() { return 30653413U; }
