...
static_assert(std::is_polymorphic<FFriendStatusUIData>() == std::is_polymorphic<FDBDTableRowBase>(), "USTRUCT FFriendStatusUIData cannot be polymorphic unless super FDBDTableRowBase is polymorphic");
...
static struct FScriptStruct_DBDUIViewsMobile_StaticRegisterNativesFFriendStatusUIData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FFriendStatusUIData>(FName(TEXT("FriendStatusUIData")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FFriendStatusUIData_Hash() { return 1905138031U; }
