...
// End Cross Module References
	...
	struct Z_Construct_UClass_UHoudiniSplineComponent_Statics
	{
		...
		static const UE4CodeGen_Private::FInt64PropertyParams NewProp_CurveType_Underlying;
#if WITH_METADATA
		...
		static const UE4CodeGen_Private::FInt64PropertyParams NewProp_CurveMethod_Underlying;
#if WITH_METADATA
		...
		static const UE4CodeGen_Private::FInt64PropertyParams NewProp_CurveBreakpointParameterization_Underlying;
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FInt64PropertyParams Z_Construct_UClass_UHoudiniSplineComponent_Statics::NewProp_CurveType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Int64, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FInt64PropertyParams Z_Construct_UClass_UHoudiniSplineComponent_Statics::NewProp_CurveMethod_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Int64, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UHoudiniSplineComponent_Statics::NewProp_bIsLegacyInputCurve = { "bIsLegacyInputCurve", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UHoudiniSplineComponent), &Z_Construct_UClass_UHoudiniSplineComponent_Statics::NewProp_bIsLegacyInputCurve_SetBit, METADATA_PARAMS(Z_Construct_UClass_UHoudiniSplineComponent_Statics::NewProp_bIsLegacyInputCurve_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniSplineComponent_Statics::NewProp_bIsLegacyInputCurve_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UHoudiniSplineComponent, 885838225);
