...
// Cross Module References
	...
	DBDUIVIEWSCORE_API UFunction* Z_Construct_UDelegateFunction_DBDUIViewsCore_TutorialObjectiveCompleted__DelegateSignature();
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UCoreTutorialObjectiveItem_Statics::NewProp_TutorialObjectiveCompletedDelegate_MetaData[] = {
		{ "Category", "CoreTutorialObjectiveItem" },
		{ "ModuleRelativePath", "Public/CoreTutorialObjectiveItem.h" },
	};
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UCoreTutorialObjectiveItem_Statics::NewProp_TutorialObjectiveCompletedDelegate = { "TutorialObjectiveCompletedDelegate", nullptr, (EPropertyFlags)0x0010000000080005, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCoreTutorialObjectiveItem, TutorialObjectiveCompletedDelegate), Z_Construct_UDelegateFunction_DBDUIViewsCore_TutorialObjectiveCompleted__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UCoreTutorialObjectiveItem_Statics::NewProp_TutorialObjectiveCompletedDelegate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCoreTutorialObjectiveItem_Statics::NewProp_TutorialObjectiveCompletedDelegate_MetaData)) };
	...
	IMPLEMENT_CLASS(UCoreTutorialObjectiveItem, 803186977);
