...
static struct FScriptStruct_DBDUIViewInterfaces_StaticRegisterNativesFBaseLoadoutPartViewData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FBaseLoadoutPartViewData>(FName(TEXT("BaseLoadoutPartViewData")));
	}
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FBaseLoadoutPartViewData_Statics::NewProp_ItemId = { "ItemId", nullptr, (EPropertyFlags)0x0010000000002005, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBaseLoadoutPartViewData, ItemId), METADATA_PARAMS(Z_Construct_UScriptStruct_FBaseLoadoutPartViewData_Statics::NewProp_ItemId_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBaseLoadoutPartViewData_Statics::NewProp_ItemId_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FBaseLoadoutPartViewData_Statics::NewProp_DisplayName = { "DisplayName", nullptr, (EPropertyFlags)0x0010000000002005, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBaseLoadoutPartViewData, DisplayName), METADATA_PARAMS(Z_Construct_UScriptStruct_FBaseLoadoutPartViewData_Statics::NewProp_DisplayName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBaseLoadoutPartViewData_Statics::NewProp_DisplayName_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FBaseLoadoutPartViewData_Statics::NewProp_Rarity = { "Rarity", nullptr, (EPropertyFlags)0x0010000000002005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBaseLoadoutPartViewData, Rarity), Z_Construct_UEnum_DBDSharedTypes_EItemRarity, METADATA_PARAMS(Z_Construct_UScriptStruct_FBaseLoadoutPartViewData_Statics::NewProp_Rarity_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBaseLoadoutPartViewData_Statics::NewProp_Rarity_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FBaseLoadoutPartViewData_Hash() { return 1625272794U; }
