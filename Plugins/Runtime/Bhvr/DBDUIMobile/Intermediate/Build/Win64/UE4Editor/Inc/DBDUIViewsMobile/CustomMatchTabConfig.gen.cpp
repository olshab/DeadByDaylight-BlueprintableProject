...
static struct FScriptStruct_DBDUIViewsMobile_StaticRegisterNativesFCustomMatchTabConfig
{
	...
	{
		UScriptStruct::DeferCppStructOps<FCustomMatchTabConfig>(FName(TEXT("CustomMatchTabConfig")));
	}
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FCustomMatchTabConfig_Statics::NewProp_ItemWidth = { "ItemWidth", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCustomMatchTabConfig, ItemWidth), METADATA_PARAMS(Z_Construct_UScriptStruct_FCustomMatchTabConfig_Statics::NewProp_ItemWidth_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCustomMatchTabConfig_Statics::NewProp_ItemWidth_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FCustomMatchTabConfig_Statics::NewProp_ItemHeight = { "ItemHeight", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCustomMatchTabConfig, ItemHeight), METADATA_PARAMS(Z_Construct_UScriptStruct_FCustomMatchTabConfig_Statics::NewProp_ItemHeight_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCustomMatchTabConfig_Statics::NewProp_ItemHeight_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FCustomMatchTabConfig_Statics::NewProp_Row = { "Row", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCustomMatchTabConfig, Row), METADATA_PARAMS(Z_Construct_UScriptStruct_FCustomMatchTabConfig_Statics::NewProp_Row_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCustomMatchTabConfig_Statics::NewProp_Row_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FCustomMatchTabConfig_Statics::NewProp_Column = { "Column", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCustomMatchTabConfig, Column), METADATA_PARAMS(Z_Construct_UScriptStruct_FCustomMatchTabConfig_Statics::NewProp_Column_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCustomMatchTabConfig_Statics::NewProp_Column_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FSoftClassPropertyParams Z_Construct_UScriptStruct_FCustomMatchTabConfig_Statics::NewProp_OptionButtonClass = { "OptionButtonClass", nullptr, (EPropertyFlags)0x0014000000000005, UE4CodeGen_Private::EPropertyGenFlags::SoftClass, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCustomMatchTabConfig, OptionButtonClass), Z_Construct_UClass_UUMGAtlantaMatchConfigPageScrollItem_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FCustomMatchTabConfig_Statics::NewProp_OptionButtonClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCustomMatchTabConfig_Statics::NewProp_OptionButtonClass_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FCustomMatchTabConfig_Hash() { return 2598078289U; }
