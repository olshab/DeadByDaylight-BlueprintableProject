...
static struct FScriptStruct_AkAudio_StaticRegisterNativesFAkWaapiUri
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAkWaapiUri>(FName(TEXT("AkWaapiUri")));
	}
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FAkWaapiUri_Statics::NewProp_Uri = { "Uri", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAkWaapiUri, Uri), METADATA_PARAMS(Z_Construct_UScriptStruct_FAkWaapiUri_Statics::NewProp_Uri_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAkWaapiUri_Statics::NewProp_Uri_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FAkWaapiUri_Hash() { return 3115108977U; }
