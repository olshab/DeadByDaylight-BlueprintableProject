...
UBasePerkIconStrategy* UPerk::GetPerkIconStrategy() const
{
	return NULL;
}
...
void UPerk::Authority_TriggerCooldownTimer(const float cooldownTime)
{
...
UPerk::UPerk()
{
	...
	this->_isUsable = true;
	this->_keepImposedStatusEffectsOnEndPlay = false;
	...
	this->SetInactiveDuringCooldown = false;
	this->_perkIconStrategy = NULL;
	this->_tokenCount = 0;
	this->_maxTokenCount = 3;
	this->_tokenSoundStrategy = EPerkTokenSoundStrategy::NoSound;
	this->_cooldownTimer = NULL;
	this->_hudIconTimer = NULL;
	this->_activatableInteraction = NULL;
}
