...
static struct FScriptStruct_DBDUIViewsMobile_StaticRegisterNativesFActionOnFriend
{
	...
	{
		UScriptStruct::DeferCppStructOps<FActionOnFriend>(FName(TEXT("ActionOnFriend")));
	}
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FActionOnFriend_Statics::NewProp_ActionOwner = { "ActionOwner", nullptr, (EPropertyFlags)0x001000000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FActionOnFriend, ActionOwner), Z_Construct_UClass_UUMGBaseFriendListElement_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FActionOnFriend_Statics::NewProp_ActionOwner_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FActionOnFriend_Statics::NewProp_ActionOwner_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FActionOnFriend_Hash() { return 3251768086U; }
