...
// End Cross Module References
	...
	DEFINE_FUNCTION(IPerkViewInterface::execUpdatePerkCooldown)
	{
		...
		P_GET_UBOOL(Z_Param_IsRechargeable);
		P_GET_UBOOL(Z_Param_IsRechargeableActive);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->UpdatePerkCooldown_Implementation(Z_Param_cooldownValue,Z_Param_IsRechargeable,Z_Param_IsRechargeableActive);
		P_NATIVE_END;
	}
	...
	void Z_Construct_UFunction_UPerkViewInterface_UpdatePerkCooldown_Statics::NewProp_IsRechargeable_SetBit(void* Obj)
	{
		((PerkViewInterface_eventUpdatePerkCooldown_Parms*)Obj)->IsRechargeable = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UPerkViewInterface_UpdatePerkCooldown_Statics::NewProp_IsRechargeable = { "IsRechargeable", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(PerkViewInterface_eventUpdatePerkCooldown_Parms), &Z_Construct_UFunction_UPerkViewInterface_UpdatePerkCooldown_Statics::NewProp_IsRechargeable_SetBit, METADATA_PARAMS(nullptr, 0) };
	void Z_Construct_UFunction_UPerkViewInterface_UpdatePerkCooldown_Statics::NewProp_IsRechargeableActive_SetBit(void* Obj)
	{
		((PerkViewInterface_eventUpdatePerkCooldown_Parms*)Obj)->IsRechargeableActive = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UPerkViewInterface_UpdatePerkCooldown_Statics::NewProp_IsRechargeableActive = { "IsRechargeableActive", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(PerkViewInterface_eventUpdatePerkCooldown_Parms), &Z_Construct_UFunction_UPerkViewInterface_UpdatePerkCooldown_Statics::NewProp_IsRechargeableActive_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UPerkViewInterface_UpdatePerkCooldown_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPerkViewInterface_UpdatePerkCooldown_Statics::NewProp_IsRechargeable,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPerkViewInterface_UpdatePerkCooldown_Statics::NewProp_IsRechargeableActive,
	};
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UPerkViewInterface_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UPerkViewInterface_UpdatePerkCooldown, "UpdatePerkCooldown" }, // 3663480733
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UPerkViewInterface, 1562039287);
	...
	void IPerkViewInterface::Execute_UpdatePerkCooldown(UObject* O, float cooldownValue, bool IsRechargeable, bool IsRechargeableActive)
	{
		check(O != NULL);
		check(O->GetClass()->ImplementsInterface(UPerkViewInterface::StaticClass()));
		...
		{
			I->UpdatePerkCooldown_Implementation(cooldownValue,IsRechargeable,IsRechargeableActive);
		}
	}
