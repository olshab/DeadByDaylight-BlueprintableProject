...
// End Cross Module References
	DEFINE_FUNCTION(UCorePlayerStatusWidget::execCacheViewData)
	{
		P_GET_STRUCT(FPlayerStatusViewData,Z_Param_data);
		P_FINISH;
		P_NATIVE_BEGIN;
		*(FPlayerStatusViewData*)Z_Param__Result=P_THIS->CacheViewData(Z_Param_data);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UCorePlayerStatusWidget::execGetKillerStatusDataMappingDB)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(UDataTable**)Z_Param__Result=P_THIS->GetKillerStatusDataMappingDB();
		P_NATIVE_END;
	}
	...
	void UCorePlayerStatusWidget::StaticRegisterNativesUCorePlayerStatusWidget()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "CacheViewData", &UCorePlayerStatusWidget::execCacheViewData },
			{ "GetKillerStatusDataMappingDB", &UCorePlayerStatusWidget::execGetKillerStatusDataMappingDB },
	...
	struct Z_Construct_UFunction_UCorePlayerStatusWidget_CacheViewData_Statics
	{
		struct CorePlayerStatusWidget_eventCacheViewData_Parms
		{
			FPlayerStatusViewData data;
			FPlayerStatusViewData ReturnValue;
		};
	...
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UCorePlayerStatusWidget_CacheViewData_Statics::NewProp_data = { "data", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(CorePlayerStatusWidget_eventCacheViewData_Parms, data), Z_Construct_UScriptStruct_FPlayerStatusViewData, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UCorePlayerStatusWidget_CacheViewData_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(CorePlayerStatusWidget_eventCacheViewData_Parms, ReturnValue), Z_Construct_UScriptStruct_FPlayerStatusViewData, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UCorePlayerStatusWidget_CacheViewData_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UCorePlayerStatusWidget_CacheViewData_Statics::NewProp_data,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UCorePlayerStatusWidget_CacheViewData_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UCorePlayerStatusWidget_CacheViewData_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/CorePlayerStatusWidget.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UCorePlayerStatusWidget_CacheViewData_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCorePlayerStatusWidget, nullptr, "CacheViewData", nullptr, nullptr, sizeof(CorePlayerStatusWidget_eventCacheViewData_Parms), Z_Construct_UFunction_UCorePlayerStatusWidget_CacheViewData_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCorePlayerStatusWidget_CacheViewData_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04080401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UCorePlayerStatusWidget_CacheViewData_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UCorePlayerStatusWidget_CacheViewData_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UCorePlayerStatusWidget_CacheViewData()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UCorePlayerStatusWidget_CacheViewData_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UCorePlayerStatusWidget_GetKillerStatusDataMappingDB_Statics
	{
		struct CorePlayerStatusWidget_eventGetKillerStatusDataMappingDB_Parms
		{
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UCorePlayerStatusWidget_GetKillerStatusDataMappingDB_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(CorePlayerStatusWidget_eventGetKillerStatusDataMappingDB_Parms, ReturnValue), Z_Construct_UClass_UDataTable_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UCorePlayerStatusWidget_GetKillerStatusDataMappingDB_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UCorePlayerStatusWidget_GetKillerStatusDataMappingDB_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UCorePlayerStatusWidget_GetKillerStatusDataMappingDB_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/CorePlayerStatusWidget.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UCorePlayerStatusWidget_GetKillerStatusDataMappingDB_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCorePlayerStatusWidget, nullptr, "GetKillerStatusDataMappingDB", nullptr, nullptr, sizeof(CorePlayerStatusWidget_eventGetKillerStatusDataMappingDB_Parms), Z_Construct_UFunction_UCorePlayerStatusWidget_GetKillerStatusDataMappingDB_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCorePlayerStatusWidget_GetKillerStatusDataMappingDB_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UCorePlayerStatusWidget_GetKillerStatusDataMappingDB_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UCorePlayerStatusWidget_GetKillerStatusDataMappingDB_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UCorePlayerStatusWidget_GetKillerStatusDataMappingDB()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UCorePlayerStatusWidget_GetKillerStatusDataMappingDB_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_MaxNameLength_MetaData[];
#endif
		static const UE4CodeGen_Private::FIntPropertyParams NewProp_MaxNameLength;
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp__killerStatusDataMappingDB_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp__killerStatusDataMappingDB;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCorePlayerStatusWidget_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCorePlayerStatusWidget_CacheViewData, "CacheViewData" }, // 1281539010
		{ &Z_Construct_UFunction_UCorePlayerStatusWidget_GetKillerStatusDataMappingDB, "GetKillerStatusDataMappingDB" }, // 40533043
		{ &Z_Construct_UFunction_UCorePlayerStatusWidget_GetKillerStatusEffectWidget, "GetKillerStatusEffectWidget" }, // 3735995909
		{ &Z_Construct_UFunction_UCorePlayerStatusWidget_GetPlayerStateChangeType, "GetPlayerStateChangeType" }, // 2169351606
		{ &Z_Construct_UFunction_UCorePlayerStatusWidget_HasKillerStatusDataChanged, "HasKillerStatusDataChanged" }, // 3911967670
		{ &Z_Construct_UFunction_UCorePlayerStatusWidget_HasObsessionStateChanged, "HasObsessionStateChanged" }, // 3681269733
		{ &Z_Construct_UFunction_UCorePlayerStatusWidget_HasPlayerStateChanged, "HasPlayerStateChanged" }, // 100463654
		{ &Z_Construct_UFunction_UCorePlayerStatusWidget_HasPlayerStatusDataChanged, "HasPlayerStatusDataChanged" }, // 2396323606
		{ &Z_Construct_UFunction_UCorePlayerStatusWidget_HasTimerProgressChanged, "HasTimerProgressChanged" }, // 3450875923
		{ &Z_Construct_UFunction_UCorePlayerStatusWidget_ShouldPlaySleepAnimation, "ShouldPlaySleepAnimation" }, // 1009604878
	};
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UCorePlayerStatusWidget_Statics::NewProp_MaxNameLength_MetaData[] = {
		{ "Category", "CorePlayerStatusWidget" },
		{ "ModuleRelativePath", "Public/CorePlayerStatusWidget.h" },
	};
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UCorePlayerStatusWidget_Statics::NewProp_MaxNameLength = { "MaxNameLength", nullptr, (EPropertyFlags)0x0020080000000005, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCorePlayerStatusWidget, MaxNameLength), METADATA_PARAMS(Z_Construct_UClass_UCorePlayerStatusWidget_Statics::NewProp_MaxNameLength_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCorePlayerStatusWidget_Statics::NewProp_MaxNameLength_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCorePlayerStatusWidget_Statics::NewProp_ObsessionSfx = { "ObsessionSfx", nullptr, (EPropertyFlags)0x0020080000000005, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCorePlayerStatusWidget, ObsessionSfx), Z_Construct_UClass_UAkAudioEvent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCorePlayerStatusWidget_Statics::NewProp_ObsessionSfx_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCorePlayerStatusWidget_Statics::NewProp_ObsessionSfx_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCorePlayerStatusWidget_Statics::NewProp_PlayerNameTextfield = { "PlayerNameTextfield", nullptr, (EPropertyFlags)0x002008000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCorePlayerStatusWidget, PlayerNameTextfield), Z_Construct_UClass_UDBDTextBlock_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCorePlayerStatusWidget_Statics::NewProp_PlayerNameTextfield_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCorePlayerStatusWidget_Statics::NewProp_PlayerNameTextfield_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCorePlayerStatusWidget_Statics::NewProp_KillerStatusContainer = { "KillerStatusContainer", nullptr, (EPropertyFlags)0x002008000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCorePlayerStatusWidget, KillerStatusContainer), Z_Construct_UClass_UOverlay_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCorePlayerStatusWidget_Statics::NewProp_KillerStatusContainer_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCorePlayerStatusWidget_Statics::NewProp_KillerStatusContainer_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCorePlayerStatusWidget_Statics::NewProp__cachedViewData = { "_cachedViewData", nullptr, (EPropertyFlags)0x0020080000002005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCorePlayerStatusWidget, _cachedViewData), Z_Construct_UScriptStruct_FPlayerStatusViewData, METADATA_PARAMS(Z_Construct_UClass_UCorePlayerStatusWidget_Statics::NewProp__cachedViewData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCorePlayerStatusWidget_Statics::NewProp__cachedViewData_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCorePlayerStatusWidget_Statics::NewProp__killerStatusEffectWidget = { "_killerStatusEffectWidget", nullptr, (EPropertyFlags)0x004000000008200d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCorePlayerStatusWidget, _killerStatusEffectWidget), Z_Construct_UClass_UCorePlayerStatusKillerEffectWidget_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCorePlayerStatusWidget_Statics::NewProp__killerStatusEffectWidget_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCorePlayerStatusWidget_Statics::NewProp__killerStatusEffectWidget_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UCorePlayerStatusWidget_Statics::NewProp__killerStatusDataMappingDB_MetaData[] = {
		{ "AllowPrivateAccess", "TRUE" },
		{ "Category", "CorePlayerStatusWidget" },
		{ "ModuleRelativePath", "Public/CorePlayerStatusWidget.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCorePlayerStatusWidget_Statics::NewProp__killerStatusDataMappingDB = { "_killerStatusDataMappingDB", nullptr, (EPropertyFlags)0x0040000000000005, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCorePlayerStatusWidget, _killerStatusDataMappingDB), Z_Construct_UClass_UDataTable_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCorePlayerStatusWidget_Statics::NewProp__killerStatusDataMappingDB_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCorePlayerStatusWidget_Statics::NewProp__killerStatusDataMappingDB_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UCorePlayerStatusWidget_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UCorePlayerStatusWidget_Statics::NewProp_MaxNameLength,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UCorePlayerStatusWidget_Statics::NewProp__killerStatusDataMappingDB,
	};
	...
	IMPLEMENT_CLASS(UCorePlayerStatusWidget, 3533364444);
