...
// End Cross Module References
	...
	DEFINE_FUNCTION(IMatchResultViewInterface::execSetMatchResultVisibility)
	{
		P_GET_ENUM(ESlateVisibility,Z_Param_visibility);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->SetMatchResultVisibility_Implementation(ESlateVisibility(Z_Param_visibility));
		P_NATIVE_END;
	}
	...
	{
		check(0 && "Do not directly call Event functions in Interfaces. Call Execute_SetMatchResultVisibility instead.");
	}
	...
	void UMatchResultViewInterface::StaticRegisterNativesUMatchResultViewInterface()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "SetMatchResultVisibility", &IMatchResultViewInterface::execSetMatchResultVisibility },
	...
	struct Z_Construct_UFunction_UMatchResultViewInterface_SetMatchResultVisibility_Statics
	{
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UMatchResultViewInterface_SetMatchResultVisibility_Statics::NewProp_visibility_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UMatchResultViewInterface_SetMatchResultVisibility_Statics::NewProp_visibility = { "visibility", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MatchResultViewInterface_eventSetMatchResultVisibility_Parms, visibility), Z_Construct_UEnum_UMG_ESlateVisibility, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UMatchResultViewInterface_SetMatchResultVisibility_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMatchResultViewInterface_SetMatchResultVisibility_Statics::NewProp_visibility_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMatchResultViewInterface_SetMatchResultVisibility_Statics::NewProp_visibility,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMatchResultViewInterface_SetMatchResultVisibility_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/MatchResultViewInterface.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UMatchResultViewInterface_SetMatchResultVisibility_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMatchResultViewInterface, nullptr, "SetMatchResultVisibility", nullptr, nullptr, sizeof(MatchResultViewInterface_eventSetMatchResultVisibility_Parms), Z_Construct_UFunction_UMatchResultViewInterface_SetMatchResultVisibility_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMatchResultViewInterface_SetMatchResultVisibility_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UMatchResultViewInterface_SetMatchResultVisibility_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UMatchResultViewInterface_SetMatchResultVisibility_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UMatchResultViewInterface_SetMatchResultVisibility()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UMatchResultViewInterface_SetMatchResultVisibility_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMatchResultViewInterface_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UMatchResultViewInterface_SetMatchResultVisibility, "SetMatchResultVisibility" }, // 1578752100
	...
	IMPLEMENT_CLASS(UMatchResultViewInterface, 2030968815);
	...
	static FName NAME_UMatchResultViewInterface_SetMatchResultVisibility = FName(TEXT("SetMatchResultVisibility"));
	void IMatchResultViewInterface::Execute_SetMatchResultVisibility(UObject* O, ESlateVisibility visibility)
	{
		check(O != NULL);
		check(O->GetClass()->ImplementsInterface(UMatchResultViewInterface::StaticClass()));
		MatchResultViewInterface_eventSetMatchResultVisibility_Parms Parms;
		UFunction* const Func = O->FindFunction(NAME_UMatchResultViewInterface_SetMatchResultVisibility);
		if (Func)
		{
		...
		{
			I->SetMatchResultVisibility_Implementation(visibility);
		}
	}
