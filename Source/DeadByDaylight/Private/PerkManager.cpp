...
void UPerkManager::PopulateSpecialModifierSets()
{
...
UStatusEffect* UPerkManager::GetStatusEffectByClass(const UClass* type) const
{
	return NULL;
}
...
float UPerkManager::GetAveragePerkModifierValue(FGameplayTag type) const
{
	return 0.0f;
}
...
void UPerkManager::Authority_RemoveStatusEffectByClass(const UClass* effectClass, bool bRemoveAllOfSameClass)
{
