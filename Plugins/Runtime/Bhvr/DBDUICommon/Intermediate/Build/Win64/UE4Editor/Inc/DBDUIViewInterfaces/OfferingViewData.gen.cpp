...
static_assert(std::is_polymorphic<FOfferingViewData>() == std::is_polymorphic<FBaseLoadoutPartViewData>(), "USTRUCT FOfferingViewData cannot be polymorphic unless super FBaseLoadoutPartViewData is polymorphic");
...
static struct FScriptStruct_DBDUIViewInterfaces_StaticRegisterNativesFOfferingViewData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FOfferingViewData>(FName(TEXT("OfferingViewData")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FOfferingViewData_Hash() { return 2490525193U; }
