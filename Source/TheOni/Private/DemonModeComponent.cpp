...
TArray<USkeletalMeshComponent*> UDemonModeComponent::GetNormalModeCustomization() const
{
...
TArray<USkeletalMeshComponent*> UDemonModeComponent::GetDemonModeCustomization() const
{
	return TArray<USkeletalMeshComponent*>();
}
...
UDemonModeComponent::UDemonModeComponent()
{
	...
	this->_normalModeCustomization = TArray<USkeletalMeshComponent*>();
	this->_demonModeCustomization = TArray<USkeletalMeshComponent*>();
	this->_demonModeVfx = TArray<UParticleSystemComponent*>();
}
