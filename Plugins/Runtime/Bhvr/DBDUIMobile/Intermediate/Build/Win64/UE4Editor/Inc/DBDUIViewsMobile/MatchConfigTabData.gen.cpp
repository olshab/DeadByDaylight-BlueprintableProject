...
static struct FScriptStruct_DBDUIViewsMobile_StaticRegisterNativesFMatchConfigTabData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMatchConfigTabData>(FName(TEXT("MatchConfigTabData")));
	}
...
#endif
	const UE4CodeGen_Private::FSoftClassPropertyParams Z_Construct_UScriptStruct_FMatchConfigTabData_Statics::NewProp_Widget = { "Widget", nullptr, (EPropertyFlags)0x0014000000000005, UE4CodeGen_Private::EPropertyGenFlags::SoftClass, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMatchConfigTabData, Widget), Z_Construct_UClass_UUMGAtlantaMatchConfigTab_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FMatchConfigTabData_Statics::NewProp_Widget_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMatchConfigTabData_Statics::NewProp_Widget_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FMatchConfigTabData_Hash() { return 3041331434U; }
