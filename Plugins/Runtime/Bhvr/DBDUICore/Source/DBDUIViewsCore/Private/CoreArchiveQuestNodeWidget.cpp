...
UCoreArchiveQuestNodeWidget::UCoreArchiveQuestNodeWidget()
{
	...
	this->Icon = NULL;
	this->VignetteTextIndicatorOverlay = NULL;
	this->VignetteImageIndicatorOverlay = NULL;
	this->VignetteCurrencyAmountOverlay = NULL;
	this->VignetteCurrencyAmountText = NULL;
