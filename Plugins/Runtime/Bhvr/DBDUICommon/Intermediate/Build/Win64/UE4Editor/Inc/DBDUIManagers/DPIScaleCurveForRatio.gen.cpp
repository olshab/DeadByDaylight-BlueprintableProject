...
static_assert(std::is_polymorphic<FDPIScaleCurveForRatio>() == std::is_polymorphic<FDBDTableRowBase>(), "USTRUCT FDPIScaleCurveForRatio cannot be polymorphic unless super FDBDTableRowBase is polymorphic");
...
static struct FScriptStruct_DBDUIManagers_StaticRegisterNativesFDPIScaleCurveForRatio
{
	...
	{
		UScriptStruct::DeferCppStructOps<FDPIScaleCurveForRatio>(FName(TEXT("DPIScaleCurveForRatio")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FDPIScaleCurveForRatio_Hash() { return 1029641548U; }
