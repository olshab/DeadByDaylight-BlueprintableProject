...
static struct FScriptStruct_DBDUIViewInterfaces_StaticRegisterNativesFOnboardingTutorialViewData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FOnboardingTutorialViewData>(FName(TEXT("OnboardingTutorialViewData")));
	}
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FOnboardingTutorialViewData_Statics::NewProp_ButtonStyle = { "ButtonStyle", nullptr, (EPropertyFlags)0x0010000000002005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FOnboardingTutorialViewData, ButtonStyle), Z_Construct_UEnum_DBDSharedTypes_EOnboardingTutorialButtonStyle, METADATA_PARAMS(Z_Construct_UScriptStruct_FOnboardingTutorialViewData_Statics::NewProp_ButtonStyle_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOnboardingTutorialViewData_Statics::NewProp_ButtonStyle_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FOnboardingTutorialViewData_Hash() { return 2651952722U; }
