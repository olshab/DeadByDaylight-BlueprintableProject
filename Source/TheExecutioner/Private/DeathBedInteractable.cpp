...
void ADeathBedInteractable::TeleportCamperToDeathBed(bool shouldActivate)
{
...
ADeathBedInteractable::ADeathBedInteractable()
{
	...
	this->_deathBedSkeletalMesh = CreateDefaultSubobject<UDBDSkeletalMeshComponentBudgeted>(TEXT("DeathBedSkeletalMesh"));
