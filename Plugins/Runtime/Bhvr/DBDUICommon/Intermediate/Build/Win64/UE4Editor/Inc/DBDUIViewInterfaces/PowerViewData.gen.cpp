...
static_assert(std::is_polymorphic<FPowerViewData>() == std::is_polymorphic<FBaseLoadoutPartViewData>(), "USTRUCT FPowerViewData cannot be polymorphic unless super FBaseLoadoutPartViewData is polymorphic");
...
static struct FScriptStruct_DBDUIViewInterfaces_StaticRegisterNativesFPowerViewData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FPowerViewData>(FName(TEXT("PowerViewData")));
	}
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FPowerViewData_Statics::NewProp_IsAvailable_MetaData[] = {
		{ "Category", "PowerViewData" },
		{ "ModuleRelativePath", "Public/PowerViewData.h" },
	};
#endif
	void Z_Construct_UScriptStruct_FPowerViewData_Statics::NewProp_IsAvailable_SetBit(void* Obj)
	{
		((FPowerViewData*)Obj)->IsAvailable = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FPowerViewData_Statics::NewProp_IsAvailable = { "IsAvailable", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FPowerViewData), &Z_Construct_UScriptStruct_FPowerViewData_Statics::NewProp_IsAvailable_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FPowerViewData_Statics::NewProp_IsAvailable_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPowerViewData_Statics::NewProp_IsAvailable_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FPowerViewData_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FPowerViewData_Statics::NewProp_IsAvailable,
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FPowerViewData_Hash() { return 1596186487U; }
