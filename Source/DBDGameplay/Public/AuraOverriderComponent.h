...
public:
	...
	UFUNCTION(BlueprintCallable)
	void ForceShowAura(const AActor* actor, const FLinearColor& color, bool isAlwaysVisible, const float MinimumOutlineDistanceVisible, const float MinimumOutlineDistance);
