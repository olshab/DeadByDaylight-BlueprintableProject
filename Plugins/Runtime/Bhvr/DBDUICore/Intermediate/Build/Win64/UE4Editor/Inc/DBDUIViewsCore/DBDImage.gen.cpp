...
// Cross Module References
	...
	DBDUIVIEWSCORE_API UFunction* Z_Construct_UDelegateFunction_DBDUIViewsCore_OnImageStreamingCancelled__DelegateSignature();
	DBDUIVIEWSCORE_API UFunction* Z_Construct_UDelegateFunction_DBDUIViewsCore_OnImageStreamingStarted__DelegateSignature();
	DBDUIVIEWSCORE_API UFunction* Z_Construct_UDelegateFunction_DBDUIViewsCore_OnImageStreamingCompleted__DelegateSignature();
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp__onImageStreamingCancelled_MetaData[];
#endif
		static const UE4CodeGen_Private::FMulticastDelegatePropertyParams NewProp__onImageStreamingCancelled;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp__onImageStreamingStarted_MetaData[];
#endif
		static const UE4CodeGen_Private::FMulticastDelegatePropertyParams NewProp__onImageStreamingStarted;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp__onImageStreamingCompleted_MetaData[];
#endif
		static const UE4CodeGen_Private::FMulticastDelegatePropertyParams NewProp__onImageStreamingCompleted;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UDBDImage_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UDBDImage_SetBrushFromSoftTextureWithDefault, "SetBrushFromSoftTextureWithDefault" }, // 4046341415
		{ &Z_Construct_UFunction_UDBDImage_SetBrushFromTextureWithDefault, "SetBrushFromTextureWithDefault" }, // 3864062692
	};
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDBDImage_Statics::NewProp__onImageStreamingCancelled_MetaData[] = {
		{ "Category", "DBDImage" },
		{ "ModuleRelativePath", "Public/DBDImage.h" },
	};
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UDBDImage_Statics::NewProp__onImageStreamingCancelled = { "_onImageStreamingCancelled", nullptr, (EPropertyFlags)0x0010000010080005, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDBDImage, _onImageStreamingCancelled), Z_Construct_UDelegateFunction_DBDUIViewsCore_OnImageStreamingCancelled__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UDBDImage_Statics::NewProp__onImageStreamingCancelled_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDBDImage_Statics::NewProp__onImageStreamingCancelled_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDBDImage_Statics::NewProp__onImageStreamingStarted_MetaData[] = {
		{ "Category", "DBDImage" },
		{ "ModuleRelativePath", "Public/DBDImage.h" },
	};
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UDBDImage_Statics::NewProp__onImageStreamingStarted = { "_onImageStreamingStarted", nullptr, (EPropertyFlags)0x0010000010080005, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDBDImage, _onImageStreamingStarted), Z_Construct_UDelegateFunction_DBDUIViewsCore_OnImageStreamingStarted__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UDBDImage_Statics::NewProp__onImageStreamingStarted_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDBDImage_Statics::NewProp__onImageStreamingStarted_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDBDImage_Statics::NewProp__onImageStreamingCompleted_MetaData[] = {
		{ "Category", "DBDImage" },
		{ "ModuleRelativePath", "Public/DBDImage.h" },
	};
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UDBDImage_Statics::NewProp__onImageStreamingCompleted = { "_onImageStreamingCompleted", nullptr, (EPropertyFlags)0x0010000010080005, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDBDImage, _onImageStreamingCompleted), Z_Construct_UDelegateFunction_DBDUIViewsCore_OnImageStreamingCompleted__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UDBDImage_Statics::NewProp__onImageStreamingCompleted_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDBDImage_Statics::NewProp__onImageStreamingCompleted_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UDBDImage_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDBDImage_Statics::NewProp__onImageStreamingCancelled,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDBDImage_Statics::NewProp__onImageStreamingStarted,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDBDImage_Statics::NewProp__onImageStreamingCompleted,
	};
	...
	IMPLEMENT_CLASS(UDBDImage, 3543218564);
