...
// End Cross Module References
	DEFINE_FUNCTION(UCustomizationTooltipWidget::execAppendToDescriptionText)
	{
		P_GET_PROPERTY_REF(FTextProperty,Z_Param_Out_appendedText);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->AppendToDescriptionText(Z_Param_Out_appendedText);
		P_NATIVE_END;
	}
	...
	void UCustomizationTooltipWidget::StaticRegisterNativesUCustomizationTooltipWidget()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "AppendToDescriptionText", &UCustomizationTooltipWidget::execAppendToDescriptionText },
			{ "SetStatusText", &UCustomizationTooltipWidget::execSetStatusText },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, UE_ARRAY_COUNT(Funcs));
	}
	struct Z_Construct_UFunction_UCustomizationTooltipWidget_AppendToDescriptionText_Statics
	{
		struct CustomizationTooltipWidget_eventAppendToDescriptionText_Parms
		{
			FText appendedText;
		};
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_appendedText_MetaData[];
#endif
		static const UE4CodeGen_Private::FTextPropertyParams NewProp_appendedText;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UCustomizationTooltipWidget_AppendToDescriptionText_Statics::NewProp_appendedText_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FTextPropertyParams Z_Construct_UFunction_UCustomizationTooltipWidget_AppendToDescriptionText_Statics::NewProp_appendedText = { "appendedText", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(CustomizationTooltipWidget_eventAppendToDescriptionText_Parms, appendedText), METADATA_PARAMS(Z_Construct_UFunction_UCustomizationTooltipWidget_AppendToDescriptionText_Statics::NewProp_appendedText_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UCustomizationTooltipWidget_AppendToDescriptionText_Statics::NewProp_appendedText_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UCustomizationTooltipWidget_AppendToDescriptionText_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UCustomizationTooltipWidget_AppendToDescriptionText_Statics::NewProp_appendedText,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UCustomizationTooltipWidget_AppendToDescriptionText_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/CustomizationTooltipWidget.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UCustomizationTooltipWidget_AppendToDescriptionText_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCustomizationTooltipWidget, nullptr, "AppendToDescriptionText", nullptr, nullptr, sizeof(CustomizationTooltipWidget_eventAppendToDescriptionText_Parms), Z_Construct_UFunction_UCustomizationTooltipWidget_AppendToDescriptionText_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCustomizationTooltipWidget_AppendToDescriptionText_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UCustomizationTooltipWidget_AppendToDescriptionText_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UCustomizationTooltipWidget_AppendToDescriptionText_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UCustomizationTooltipWidget_AppendToDescriptionText()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UCustomizationTooltipWidget_AppendToDescriptionText_Statics::FuncParams);
		}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCustomizationTooltipWidget_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCustomizationTooltipWidget_AppendToDescriptionText, "AppendToDescriptionText" }, // 3270651438
		{ &Z_Construct_UFunction_UCustomizationTooltipWidget_SetStatusText, "SetStatusText" }, // 4266234856
		{ &Z_Construct_UFunction_UCustomizationTooltipWidget_SetTooltipData, "SetTooltipData" }, // 2430699110
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCustomizationTooltipWidget_Statics::NewProp_ToolTipStatusTB = { "ToolTipStatusTB", nullptr, (EPropertyFlags)0x002008000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCustomizationTooltipWidget, ToolTipStatusTB), Z_Construct_UClass_UDBDTextBlock_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCustomizationTooltipWidget_Statics::NewProp_ToolTipStatusTB_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCustomizationTooltipWidget_Statics::NewProp_ToolTipStatusTB_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UCustomizationTooltipWidget_Statics::NewProp_ToolTipDescriptionRTB_MetaData[] = {
		{ "BindWidget", "" },
		{ "Category", "CustomizationTooltipWidget" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/CustomizationTooltipWidget.h" },
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCustomizationTooltipWidget_Statics::NewProp_ToolTipDescriptionRTB = { "ToolTipDescriptionRTB", nullptr, (EPropertyFlags)0x002008000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCustomizationTooltipWidget, ToolTipDescriptionRTB), Z_Construct_UClass_UDBDRichTextBlock_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCustomizationTooltipWidget_Statics::NewProp_ToolTipDescriptionRTB_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCustomizationTooltipWidget_Statics::NewProp_ToolTipDescriptionRTB_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UCustomizationTooltipWidget_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UCustomizationTooltipWidget_Statics::NewProp_ToolTipDescriptionRTB,
	};
	...
	IMPLEMENT_CLASS(UCustomizationTooltipWidget, 1544988525);
