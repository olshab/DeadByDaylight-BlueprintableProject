...
UStatusEffect::UStatusEffect()
{
	...
	this->ShouldHideStatusEffectIconForOriginatingPlayer = false;
	this->_forceActivationTimerDisplay = false;
	this->_nonStackingEffects = TArray<TSoftClassPtr<UStatusEffect>>();
}
