...
void UFragileObjectComponent::Authority_OnCamperRemoved(ACamperPlayer* removedPlayer)
{
...
UFragileObjectComponent::UFragileObjectComponent()
{
	...
	this->_minFallingHeight = 0.000000;
	this->_generalObjectBreakingEvents = TArray<FGameplayTag>();
