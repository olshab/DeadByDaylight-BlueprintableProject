...
static struct FScriptStruct_DBDUIViewInterfaces_StaticRegisterNativesFCharacterTooltipViewData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FCharacterTooltipViewData>(FName(TEXT("CharacterTooltipViewData")));
	}
...
#endif
		static const UE4CodeGen_Private::FTextPropertyParams NewProp_PackId;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_PackTitle_MetaData[];
#endif
		static const UE4CodeGen_Private::FTextPropertyParams NewProp_PackTitle;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FCharacterTooltipViewData_Statics::NewProp_PackId_MetaData[] = {
		{ "Category", "CharacterTooltipViewData" },
		{ "ModuleRelativePath", "Public/CharacterTooltipViewData.h" },
	};
#endif
	const UE4CodeGen_Private::FTextPropertyParams Z_Construct_UScriptStruct_FCharacterTooltipViewData_Statics::NewProp_PackId = { "PackId", nullptr, (EPropertyFlags)0x0010000000002005, UE4CodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCharacterTooltipViewData, PackId), METADATA_PARAMS(Z_Construct_UScriptStruct_FCharacterTooltipViewData_Statics::NewProp_PackId_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCharacterTooltipViewData_Statics::NewProp_PackId_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FCharacterTooltipViewData_Statics::NewProp_PackTitle_MetaData[] = {
		{ "Category", "CharacterTooltipViewData" },
		{ "ModuleRelativePath", "Public/CharacterTooltipViewData.h" },
	};
#endif
	const UE4CodeGen_Private::FTextPropertyParams Z_Construct_UScriptStruct_FCharacterTooltipViewData_Statics::NewProp_PackTitle = { "PackTitle", nullptr, (EPropertyFlags)0x0010000000002005, UE4CodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCharacterTooltipViewData, PackTitle), METADATA_PARAMS(Z_Construct_UScriptStruct_FCharacterTooltipViewData_Statics::NewProp_PackTitle_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCharacterTooltipViewData_Statics::NewProp_PackTitle_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FCharacterTooltipViewData_Statics::NewProp_IsEnabled = { "IsEnabled", nullptr, (EPropertyFlags)0x0010000000002005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FCharacterTooltipViewData), &Z_Construct_UScriptStruct_FCharacterTooltipViewData_Statics::NewProp_IsEnabled_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FCharacterTooltipViewData_Statics::NewProp_IsEnabled_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCharacterTooltipViewData_Statics::NewProp_IsEnabled_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FCharacterTooltipViewData_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FCharacterTooltipViewData_Statics::NewProp_PackId,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FCharacterTooltipViewData_Statics::NewProp_PackTitle,
	...
	uint32 Get_Z_Construct_UScriptStruct_FCharacterTooltipViewData_Hash() { return 3461640887U; }
