...
static_assert(std::is_polymorphic<FPerkViewData>() == std::is_polymorphic<FBaseLoadoutPartViewData>(), "USTRUCT FPerkViewData cannot be polymorphic unless super FBaseLoadoutPartViewData is polymorphic");
...
static struct FScriptStruct_DBDUIViewInterfaces_StaticRegisterNativesFPerkViewData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FPerkViewData>(FName(TEXT("PerkViewData")));
	}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_IsRechargeableActive_MetaData[];
#endif
		static void NewProp_IsRechargeableActive_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_IsRechargeableActive;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FPerkViewData_Statics::NewProp_IsRechargeable_MetaData[] = {
		{ "Category", "PerkViewData" },
		{ "ModuleRelativePath", "Public/PerkViewData.h" },
	};
#endif
	void Z_Construct_UScriptStruct_FPerkViewData_Statics::NewProp_IsRechargeable_SetBit(void* Obj)
	{
		((FPerkViewData*)Obj)->IsRechargeable = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FPerkViewData_Statics::NewProp_IsRechargeable = { "IsRechargeable", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FPerkViewData), &Z_Construct_UScriptStruct_FPerkViewData_Statics::NewProp_IsRechargeable_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FPerkViewData_Statics::NewProp_IsRechargeable_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPerkViewData_Statics::NewProp_IsRechargeable_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FPerkViewData_Statics::NewProp_IsRechargeableActive_MetaData[] = {
		{ "Category", "PerkViewData" },
		{ "ModuleRelativePath", "Public/PerkViewData.h" },
	};
#endif
	void Z_Construct_UScriptStruct_FPerkViewData_Statics::NewProp_IsRechargeableActive_SetBit(void* Obj)
	{
		((FPerkViewData*)Obj)->IsRechargeableActive = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FPerkViewData_Statics::NewProp_IsRechargeableActive = { "IsRechargeableActive", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FPerkViewData), &Z_Construct_UScriptStruct_FPerkViewData_Statics::NewProp_IsRechargeableActive_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FPerkViewData_Statics::NewProp_IsRechargeableActive_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPerkViewData_Statics::NewProp_IsRechargeableActive_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FPerkViewData_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FPerkViewData_Statics::NewProp_IsRechargeable,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FPerkViewData_Statics::NewProp_IsRechargeableActive,
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FPerkViewData_Hash() { return 3953548155U; }
