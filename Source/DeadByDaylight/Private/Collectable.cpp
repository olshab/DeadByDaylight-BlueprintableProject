...
void ACollectable::Multicast_Dropped_Implementation(ADBDPlayer* droppedBy, const FVector& location, const FRotator& rotation, EItemDropType itemDropType)
{

}

void ACollectable::Multicast_Collected_Implementation(ADBDPlayer* collector, EInventoryType inventoryType)
{
...
bool ACollectable::CanBeCollected_Implementation(const ADBDPlayer* collector, const bool assumeWillDropItem) const
{
	return false;
}
...
void ACollectable::Authority_OnCollectorEndPlay(AActor* actor, TEnumAsByte<EEndPlayReason::Type> endPlayReason)
{
...
ACollectable::ACollectable()
{
	...
	this->_mesh = CreateDefaultSubobject<UDBDSkeletalMeshComponentBudgeted>(TEXT("ItemMesh"));
	...
	this->_isCursedItem = false;
	this->_isSpecialItem = false;
	this->_useInventoryCount = false;
