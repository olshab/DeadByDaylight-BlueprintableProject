...
static struct FScriptStruct_DBDUIViewInterfaces_StaticRegisterNativesFStatusEffectViewData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FStatusEffectViewData>(FName(TEXT("StatusEffectViewData")));
	}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_PlayIntroAnimation_MetaData[];
#endif
		static void NewProp_PlayIntroAnimation_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_PlayIntroAnimation;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FStatusEffectViewData_Statics::NewProp_PlayIntroAnimation_MetaData[] = {
		{ "Category", "StatusEffectViewData" },
		{ "ModuleRelativePath", "Public/StatusEffectViewData.h" },
	};
#endif
	void Z_Construct_UScriptStruct_FStatusEffectViewData_Statics::NewProp_PlayIntroAnimation_SetBit(void* Obj)
	{
		((FStatusEffectViewData*)Obj)->PlayIntroAnimation = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FStatusEffectViewData_Statics::NewProp_PlayIntroAnimation = { "PlayIntroAnimation", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FStatusEffectViewData), &Z_Construct_UScriptStruct_FStatusEffectViewData_Statics::NewProp_PlayIntroAnimation_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FStatusEffectViewData_Statics::NewProp_PlayIntroAnimation_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStatusEffectViewData_Statics::NewProp_PlayIntroAnimation_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FStatusEffectViewData_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FStatusEffectViewData_Statics::NewProp_PlayIntroAnimation,
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FStatusEffectViewData_Hash() { return 3766727727U; }
