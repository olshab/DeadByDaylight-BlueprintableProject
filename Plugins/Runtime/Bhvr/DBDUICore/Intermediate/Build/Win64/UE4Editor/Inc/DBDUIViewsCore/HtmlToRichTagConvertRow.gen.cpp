...
static_assert(std::is_polymorphic<FHtmlToRichTagConvertRow>() == std::is_polymorphic<FTableRowBase>(), "USTRUCT FHtmlToRichTagConvertRow cannot be polymorphic unless super FTableRowBase is polymorphic");
...
static struct FScriptStruct_DBDUIViewsCore_StaticRegisterNativesFHtmlToRichTagConvertRow
{
	...
	{
		UScriptStruct::DeferCppStructOps<FHtmlToRichTagConvertRow>(FName(TEXT("HtmlToRichTagConvertRow")));
	}
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FHtmlToRichTagConvertRow_Statics::NewProp_HtmlTag = { "HtmlTag", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FHtmlToRichTagConvertRow, HtmlTag), METADATA_PARAMS(Z_Construct_UScriptStruct_FHtmlToRichTagConvertRow_Statics::NewProp_HtmlTag_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHtmlToRichTagConvertRow_Statics::NewProp_HtmlTag_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FHtmlToRichTagConvertRow_Statics::NewProp_RichTextTag = { "RichTextTag", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FHtmlToRichTagConvertRow, RichTextTag), METADATA_PARAMS(Z_Construct_UScriptStruct_FHtmlToRichTagConvertRow_Statics::NewProp_RichTextTag_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHtmlToRichTagConvertRow_Statics::NewProp_RichTextTag_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FHtmlToRichTagConvertRow_Hash() { return 515555257U; }
