...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UGameManualSubPresenter_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UGameManualSubPresenter_OnCategoryCategoryEntered, "OnCategoryCategoryEntered" }, // 3931843618
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UGameManualSubPresenter_Statics::NewProp__gameManualWidget_MetaData[] = {
		...
		{ "Category", "GameManualSubPresenter" },
		{ "ModuleRelativePath", "Public/GameManualSubPresenter.h" },
	};
#endif
	const UE4CodeGen_Private::FInterfacePropertyParams Z_Construct_UClass_UGameManualSubPresenter_Statics::NewProp__gameManualWidget = { "_gameManualWidget", nullptr, (EPropertyFlags)0x0044000000002005, UE4CodeGen_Private::EPropertyGenFlags::Interface, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGameManualSubPresenter, _gameManualWidget), Z_Construct_UClass_UGameManualViewInterface_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UGameManualSubPresenter_Statics::NewProp__gameManualWidget_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGameManualSubPresenter_Statics::NewProp__gameManualWidget_MetaData)) };
	...
	IMPLEMENT_CLASS(UGameManualSubPresenter, 3594896668);
