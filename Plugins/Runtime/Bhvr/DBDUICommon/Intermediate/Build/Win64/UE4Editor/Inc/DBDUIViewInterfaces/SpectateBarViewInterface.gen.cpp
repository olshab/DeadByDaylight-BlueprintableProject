...
// End Cross Module References
	...
	DEFINE_FUNCTION(ISpectateBarViewInterface::execSetBotTag)
	{
		P_GET_UBOOL(Z_Param_isBot);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->SetBotTag_Implementation(Z_Param_isBot);
		P_NATIVE_END;
	}
	...
	void ISpectateBarViewInterface::SetBotTag(bool isBot)
	{
		check(0 && "Do not directly call Event functions in Interfaces. Call Execute_SetBotTag instead.");
	}
	...
	void USpectateBarViewInterface::StaticRegisterNativesUSpectateBarViewInterface()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "SetBotTag", &ISpectateBarViewInterface::execSetBotTag },
	...
	struct Z_Construct_UFunction_USpectateBarViewInterface_SetBotTag_Statics
	{
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USpectateBarViewInterface_SetBotTag_Statics::NewProp_isBot_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	void Z_Construct_UFunction_USpectateBarViewInterface_SetBotTag_Statics::NewProp_isBot_SetBit(void* Obj)
	{
		((SpectateBarViewInterface_eventSetBotTag_Parms*)Obj)->isBot = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_USpectateBarViewInterface_SetBotTag_Statics::NewProp_isBot = { "isBot", nullptr, (EPropertyFlags)0x0010000000000082, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(SpectateBarViewInterface_eventSetBotTag_Parms), &Z_Construct_UFunction_USpectateBarViewInterface_SetBotTag_Statics::NewProp_isBot_SetBit, METADATA_PARAMS(Z_Construct_UFunction_USpectateBarViewInterface_SetBotTag_Statics::NewProp_isBot_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_USpectateBarViewInterface_SetBotTag_Statics::NewProp_isBot_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_USpectateBarViewInterface_SetBotTag_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USpectateBarViewInterface_SetBotTag_Statics::NewProp_isBot,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USpectateBarViewInterface_SetBotTag_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/SpectateBarViewInterface.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_USpectateBarViewInterface_SetBotTag_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USpectateBarViewInterface, nullptr, "SetBotTag", nullptr, nullptr, sizeof(SpectateBarViewInterface_eventSetBotTag_Parms), Z_Construct_UFunction_USpectateBarViewInterface_SetBotTag_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USpectateBarViewInterface_SetBotTag_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_USpectateBarViewInterface_SetBotTag_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_USpectateBarViewInterface_SetBotTag_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_USpectateBarViewInterface_SetBotTag()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_USpectateBarViewInterface_SetBotTag_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USpectateBarViewInterface_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_USpectateBarViewInterface_SetBotTag, "SetBotTag" }, // 135156399
	...
	IMPLEMENT_CLASS(USpectateBarViewInterface, 2901172663);
	...
	static FName NAME_USpectateBarViewInterface_SetBotTag = FName(TEXT("SetBotTag"));
	void ISpectateBarViewInterface::Execute_SetBotTag(UObject* O, bool isBot)
	{
		check(O != NULL);
		check(O->GetClass()->ImplementsInterface(USpectateBarViewInterface::StaticClass()));
		SpectateBarViewInterface_eventSetBotTag_Parms Parms;
		UFunction* const Func = O->FindFunction(NAME_USpectateBarViewInterface_SetBotTag);
		if (Func)
		{
			Parms.isBot=isBot;
			O->ProcessEvent(Func, &Parms);
		...
		{
			I->SetBotTag_Implementation(isBot);
		}
	}
