...
static struct FScriptStruct_DBDUIViewsCore_StaticRegisterNativesFPendingStepData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FPendingStepData>(FName(TEXT("PendingStepData")));
	}
	...
	struct Z_Construct_UScriptStruct_FPendingStepData_Statics
	{
		...
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_updatedButtonViewData_Inner;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_updatedButtonViewData_MetaData[];
#endif
		static const UE4CodeGen_Private::FArrayPropertyParams NewProp_updatedButtonViewData;
	...
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FPendingStepData_Statics::NewProp_updatedButtonViewData_Inner = { "updatedButtonViewData", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FOnboardingTutorialButtonViewData, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FPendingStepData_Statics::NewProp_updatedButtonViewData_MetaData[] = {
		{ "Category", "PendingStepData" },
		{ "ModuleRelativePath", "Public/PendingStepData.h" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FPendingStepData_Statics::NewProp_updatedButtonViewData = { "updatedButtonViewData", nullptr, (EPropertyFlags)0x0010000000002005, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPendingStepData, updatedButtonViewData), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FPendingStepData_Statics::NewProp_updatedButtonViewData_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPendingStepData_Statics::NewProp_updatedButtonViewData_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FPendingStepData_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FPendingStepData_Statics::NewProp_updatedButtonViewData_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FPendingStepData_Statics::NewProp_updatedButtonViewData,
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FPendingStepData_Hash() { return 3782285126U; }
