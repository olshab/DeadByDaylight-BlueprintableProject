...
AK25Power::AK25Power()
{
	...
	this->_customKillerInstinctDatas = TArray<FCustomKillerInstinctData>();
	this->_survivorStatusEffectClasses = TArray<TSubclassOf<UStatusEffect>>();
	this->_killerStatusEffectClasses = TArray<TSubclassOf<UStatusEffect>>();
