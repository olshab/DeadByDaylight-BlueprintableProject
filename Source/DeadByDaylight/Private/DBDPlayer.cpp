...
void ADBDPlayer::Server_SendEventAbilityInput_Implementation(bool pressed)
{
...
bool ADBDPlayer::Server_GameTimeSync_Validate()
{
	return true;
}
...
bool ADBDPlayer::HasClearPathToTargetWithFilter(FVector targetPosition, TSubclassOf<AActor> classFilter, AActor* ignoreActor) const
{
	return false;
}
...
UNavigationStateComponent* ADBDPlayer::GetNavigationState() const
{
	return NULL;
}
...
ADBDPlayer::ADBDPlayer()
{
	...
	this->_navigationStateComponent = CreateDefaultSubobject<UNavigationStateComponent>(TEXT("NavigationStateComponent"));
