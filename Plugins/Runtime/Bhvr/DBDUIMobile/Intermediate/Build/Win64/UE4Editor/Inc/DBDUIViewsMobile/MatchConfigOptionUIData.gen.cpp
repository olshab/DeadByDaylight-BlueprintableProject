...
static struct FScriptStruct_DBDUIViewsMobile_StaticRegisterNativesFMatchConfigOptionUIData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMatchConfigOptionUIData>(FName(TEXT("MatchConfigOptionUIData")));
	}
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMatchConfigOptionUIData_Statics::NewProp_Id_MetaData[] = {
		{ "Category", "MatchConfigOptionUIData" },
		{ "ModuleRelativePath", "Public/MatchConfigOptionUIData.h" },
	};
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FMatchConfigOptionUIData_Statics::NewProp_Id = { "Id", nullptr, (EPropertyFlags)0x0010000000002005, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMatchConfigOptionUIData, Id), METADATA_PARAMS(Z_Construct_UScriptStruct_FMatchConfigOptionUIData_Statics::NewProp_Id_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMatchConfigOptionUIData_Statics::NewProp_Id_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FMatchConfigOptionUIData_Statics::NewProp_StringId = { "StringId", nullptr, (EPropertyFlags)0x0010000000002005, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMatchConfigOptionUIData, StringId), METADATA_PARAMS(Z_Construct_UScriptStruct_FMatchConfigOptionUIData_Statics::NewProp_StringId_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMatchConfigOptionUIData_Statics::NewProp_StringId_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FTextPropertyParams Z_Construct_UScriptStruct_FMatchConfigOptionUIData_Statics::NewProp_OptionName = { "OptionName", nullptr, (EPropertyFlags)0x0010000000002005, UE4CodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMatchConfigOptionUIData, OptionName), METADATA_PARAMS(Z_Construct_UScriptStruct_FMatchConfigOptionUIData_Statics::NewProp_OptionName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMatchConfigOptionUIData_Statics::NewProp_OptionName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FSoftObjectPropertyParams Z_Construct_UScriptStruct_FMatchConfigOptionUIData_Statics::NewProp_OptionIcon = { "OptionIcon", nullptr, (EPropertyFlags)0x0014000000002005, UE4CodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMatchConfigOptionUIData, OptionIcon), Z_Construct_UClass_UPaperSprite_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FMatchConfigOptionUIData_Statics::NewProp_OptionIcon_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMatchConfigOptionUIData_Statics::NewProp_OptionIcon_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FMatchConfigOptionUIData_Hash() { return 2169001091U; }
