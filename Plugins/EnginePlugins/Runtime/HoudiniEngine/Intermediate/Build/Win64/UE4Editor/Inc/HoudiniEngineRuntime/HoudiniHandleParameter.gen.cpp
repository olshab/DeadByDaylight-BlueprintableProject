...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UHoudiniHandleParameter_Statics::NewProp_TupleIndex = { "TupleIndex", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniHandleParameter, TupleIndex), METADATA_PARAMS(Z_Construct_UClass_UHoudiniHandleParameter_Statics::NewProp_TupleIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniHandleParameter_Statics::NewProp_TupleIndex_MetaData)) };
	...
	IMPLEMENT_CLASS(UHoudiniHandleParameter, 1611368058);
