...
// End Cross Module References
	...
	DEFINE_FUNCTION(UCharacterTooltipWidget::execSetLockDetails)
	{
		P_GET_STRUCT_REF(FCharacterTooltipViewData,Z_Param_Out_characterViewData);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->SetLockDetails(Z_Param_Out_characterViewData);
		P_NATIVE_END;
	}
	...
	void UCharacterTooltipWidget::StaticRegisterNativesUCharacterTooltipWidget()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "SetLockDetails", &UCharacterTooltipWidget::execSetLockDetails },
		};
	...
	struct Z_Construct_UFunction_UCharacterTooltipWidget_SetLockDetails_Statics
	{
		struct CharacterTooltipWidget_eventSetLockDetails_Parms
		{
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UCharacterTooltipWidget_SetLockDetails_Statics::NewProp_characterViewData_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UCharacterTooltipWidget_SetLockDetails_Statics::NewProp_characterViewData = { "characterViewData", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(CharacterTooltipWidget_eventSetLockDetails_Parms, characterViewData), Z_Construct_UScriptStruct_FCharacterTooltipViewData, METADATA_PARAMS(Z_Construct_UFunction_UCharacterTooltipWidget_SetLockDetails_Statics::NewProp_characterViewData_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UCharacterTooltipWidget_SetLockDetails_Statics::NewProp_characterViewData_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UCharacterTooltipWidget_SetLockDetails_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UCharacterTooltipWidget_SetLockDetails_Statics::NewProp_characterViewData,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UCharacterTooltipWidget_SetLockDetails_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/CharacterTooltipWidget.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UCharacterTooltipWidget_SetLockDetails_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCharacterTooltipWidget, nullptr, "SetLockDetails", nullptr, nullptr, sizeof(CharacterTooltipWidget_eventSetLockDetails_Parms), Z_Construct_UFunction_UCharacterTooltipWidget_SetLockDetails_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCharacterTooltipWidget_SetLockDetails_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04480401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UCharacterTooltipWidget_SetLockDetails_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UCharacterTooltipWidget_SetLockDetails_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UCharacterTooltipWidget_SetLockDetails()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UCharacterTooltipWidget_SetLockDetails_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_LockDetailsTB_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_LockDetailsTB;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCharacterTooltipWidget_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCharacterTooltipWidget_SetDifficulty, "SetDifficulty" }, // 1001216466
		{ &Z_Construct_UFunction_UCharacterTooltipWidget_SetLevel, "SetLevel" }, // 433017508
		{ &Z_Construct_UFunction_UCharacterTooltipWidget_SetLockDetails, "SetLockDetails" }, // 3869042043
		{ &Z_Construct_UFunction_UCharacterTooltipWidget_SetTooltipData, "SetTooltipData" }, // 4029154346
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCharacterTooltipWidget_Statics::NewProp_InstructionTB = { "InstructionTB", nullptr, (EPropertyFlags)0x002008000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCharacterTooltipWidget, InstructionTB), Z_Construct_UClass_UDBDTextBlock_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCharacterTooltipWidget_Statics::NewProp_InstructionTB_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCharacterTooltipWidget_Statics::NewProp_InstructionTB_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCharacterTooltipWidget_Statics::NewProp_LevelTB = { "LevelTB", nullptr, (EPropertyFlags)0x002008000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCharacterTooltipWidget, LevelTB), Z_Construct_UClass_UDBDTextBlock_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCharacterTooltipWidget_Statics::NewProp_LevelTB_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCharacterTooltipWidget_Statics::NewProp_LevelTB_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UCharacterTooltipWidget_Statics::NewProp_LockDetailsTB_MetaData[] = {
		{ "BindWidget", "" },
		{ "Category", "CharacterTooltipWidget" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/CharacterTooltipWidget.h" },
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCharacterTooltipWidget_Statics::NewProp_LockDetailsTB = { "LockDetailsTB", nullptr, (EPropertyFlags)0x002008000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCharacterTooltipWidget, LockDetailsTB), Z_Construct_UClass_UDBDTextBlock_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCharacterTooltipWidget_Statics::NewProp_LockDetailsTB_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCharacterTooltipWidget_Statics::NewProp_LockDetailsTB_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCharacterTooltipWidget_Statics::NewProp_DifficultyRTB = { "DifficultyRTB", nullptr, (EPropertyFlags)0x002008000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCharacterTooltipWidget, DifficultyRTB), Z_Construct_UClass_UDBDRichTextBlock_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCharacterTooltipWidget_Statics::NewProp_DifficultyRTB_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCharacterTooltipWidget_Statics::NewProp_DifficultyRTB_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UCharacterTooltipWidget_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UCharacterTooltipWidget_Statics::NewProp_LockDetailsTB,
	...
	IMPLEMENT_CLASS(UCharacterTooltipWidget, 1691177747);
