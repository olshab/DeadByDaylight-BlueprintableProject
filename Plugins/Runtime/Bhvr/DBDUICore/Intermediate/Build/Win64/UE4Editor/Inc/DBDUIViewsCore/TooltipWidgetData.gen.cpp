...
static_assert(std::is_polymorphic<FTooltipWidgetData>() == std::is_polymorphic<FDBDTableRowBase>(), "USTRUCT FTooltipWidgetData cannot be polymorphic unless super FDBDTableRowBase is polymorphic");
...
static struct FScriptStruct_DBDUIViewsCore_StaticRegisterNativesFTooltipWidgetData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FTooltipWidgetData>(FName(TEXT("TooltipWidgetData")));
	}
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FTooltipWidgetData_Statics::NewProp_TooltipType = { "TooltipType", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTooltipWidgetData, TooltipType), Z_Construct_UEnum_DBDUIViewsCore_ETooltipType, METADATA_PARAMS(Z_Construct_UScriptStruct_FTooltipWidgetData_Statics::NewProp_TooltipType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTooltipWidgetData_Statics::NewProp_TooltipType_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FTooltipWidgetData_Hash() { return 3870583441U; }
