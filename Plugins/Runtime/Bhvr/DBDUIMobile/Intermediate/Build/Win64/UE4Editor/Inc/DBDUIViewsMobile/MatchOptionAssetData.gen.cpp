...
static struct FScriptStruct_DBDUIViewsMobile_StaticRegisterNativesFMatchOptionAssetData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMatchOptionAssetData>(FName(TEXT("MatchOptionAssetData")));
	}
...
#endif
	const UE4CodeGen_Private::FTextPropertyParams Z_Construct_UScriptStruct_FMatchOptionAssetData_Statics::NewProp_TextName = { "TextName", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMatchOptionAssetData, TextName), METADATA_PARAMS(Z_Construct_UScriptStruct_FMatchOptionAssetData_Statics::NewProp_TextName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMatchOptionAssetData_Statics::NewProp_TextName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FSoftObjectPropertyParams Z_Construct_UScriptStruct_FMatchOptionAssetData_Statics::NewProp_Icon = { "Icon", nullptr, (EPropertyFlags)0x0014000000000005, UE4CodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMatchOptionAssetData, Icon), Z_Construct_UClass_UPaperSprite_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FMatchOptionAssetData_Statics::NewProp_Icon_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMatchOptionAssetData_Statics::NewProp_Icon_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FMatchOptionAssetData_Hash() { return 349578655U; }
