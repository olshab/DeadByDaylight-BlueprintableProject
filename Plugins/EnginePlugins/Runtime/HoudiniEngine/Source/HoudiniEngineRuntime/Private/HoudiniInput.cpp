...
UHoudiniInput::UHoudiniInput()
{
	...
	this->GeometryCollectionInputObjects = TArray<UHoudiniInputObject*>();
	this->LandscapeSelectedComponents = TSet<ULandscapeComponent*>();
	this->InputNodesPendingDelete = TSet<int32>();
	this->LastInsertedInputs = TArray<UHoudiniInputHoudiniSplineComponent*>();
	this->LastUndoDeletedInputs = TArray<UHoudiniInputObject*>();
	this->bUpdateInputLandscape_DEPRECATED = false;
