...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCoreEndGameCollapseBarWidget_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCoreEndGameCollapseBarWidget_PlayToZeroAnimation, "PlayToZeroAnimation" }, // 1540893691
		{ &Z_Construct_UFunction_UCoreEndGameCollapseBarWidget_UpdateBarProgression, "UpdateBarProgression" }, // 485719914
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UCoreEndGameCollapseBarWidget_Statics::NewProp__progressBarInterpSpeed = { "_progressBarInterpSpeed", nullptr, (EPropertyFlags)0x0020080000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCoreEndGameCollapseBarWidget, _progressBarInterpSpeed), METADATA_PARAMS(Z_Construct_UClass_UCoreEndGameCollapseBarWidget_Statics::NewProp__progressBarInterpSpeed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCoreEndGameCollapseBarWidget_Statics::NewProp__progressBarInterpSpeed_MetaData)) };
	...
	IMPLEMENT_CLASS(UCoreEndGameCollapseBarWidget, 481568972);
