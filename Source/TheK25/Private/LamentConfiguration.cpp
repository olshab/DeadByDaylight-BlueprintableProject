...
void ALamentConfiguration::Authority_OnOverlapEnd(UPrimitiveComponent* overlappedComponent, AActor* otherActor, UPrimitiveComponent* otherComp, int32 otherBodyIndex)
{

}

void ALamentConfiguration::Authority_OnOverlapBegin(UPrimitiveComponent* overlappedComponent, AActor* other, UPrimitiveComponent* otherComp, int32 otherBodyIndex, bool bFromSweep, const FHitResult& sweepResult)
{
...
ALamentConfiguration::ALamentConfiguration()
{
	...
	this->_dotProductMinValue = 0.500000;
	this->_survivorAttachmentSocket = EAttachToSocketNameEnum::ManualAttachment;
	this->_killerAttachmentSocket = EAttachToSocketNameEnum::ManualAttachment;
	...
	this->_localLamentConfigurationState = ELamentConfigurationState::SurvivorEscapedWithLamentConfiguration;
	this->_lamentconfigurationState = ELamentConfigurationState::SurvivorEscapedWithLamentConfiguration;
	this->_chainAnimationActor = NULL;
	this->_survivorHeldHostage = NULL;
	this->_standingOnLamentConfigurationCollisionChecker = CreateDefaultSubobject<UBoxComponent>(TEXT("StandingOnLamentConfigurationCollisionChecker"));
	this->_timeAllowedToStandOnCubeBeforeTeleport = 5.000000;
	this->_solvedLamentConfigurationDropDistanceToCollectorCentimeters = 91.300003;
	this->_failedLamentConfigurationSolveDropDistanceToCollectorCentimeters = 60.500000;
	this->_solved = false;
