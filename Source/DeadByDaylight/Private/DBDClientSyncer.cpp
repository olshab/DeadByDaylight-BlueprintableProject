...
void ADBDClientSyncer::Multicast_SyncFinalLocallySpawnCount_Implementation(int32 numLocal)
{

}

void ADBDClientSyncer::Multicast_SyncActorToSpawnLocally_Implementation(const TArray<FSpawnInfo>& spawnInfos, int32 startIndex)
{
