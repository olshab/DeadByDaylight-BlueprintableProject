...
void ADBDPlayerControllerBase::Server_EACMessageFromClient_Implementation(const TArray<uint8>& message)
{

}

bool ADBDPlayerControllerBase::Server_EACMessageFromClient_Validate(const TArray<uint8>& message)
{
	return true;
}
...
void ADBDPlayerControllerBase::Client_EACResetConnection_Implementation()
{

}

void ADBDPlayerControllerBase::Client_EACMessageFromServer_Implementation(const TArray<uint8>& message)
{

}

void ADBDPlayerControllerBase::Client_EACConnect_Implementation()
{
