...
void UInteractionDefinition::UpdateSlashableLocation(ADBDPlayer* player)
{
...
void UInteractionDefinition::ResetSlashableLocation(ADBDPlayer* player)
{

}

void UInteractionDefinition::RemoveExclusiveInteraction(UInteractionDefinition* interaction)
{
...
bool UInteractionDefinition::IsInteractionPossible(const ADBDPlayer* player, EInputInteractionType interactionType, bool performClientCheck, bool performHeightCheck, bool isBotPredictionCheck) const
{
	return false;
}
...
FVector UInteractionDefinition::GetSlashableRelativeLocation_Implementation() const
{
	return FVector{};
}
...
ADBDPlayer* UInteractionDefinition::GetPlayerDependency_Implementation(const ADBDPlayer* interactingPlayer)
{
	return NULL;
}
...
UInteractionDefinition::UInteractionDefinition()
{
	...
	this->MustBeClosestPlayerToSnapPoint = false;
	...
	this->IsOverridingInputToggleReleasePromptMessage = false;
	this->InputToggleReleasePromptMessage = TEXT("");
	...
	this->_overrideSlashableRelativeLocation = false;
