...
{
	this->_survivorDreamWorldStatusEffect = NULL;
	this->_sleepinessProtectionRemainingDuration = 0.000000;
	this->_sleepGainPerSecond = 0.000000;
	this->_wakeUpByOtherCount = 0;
	this->_showKiller = false;
	this->_glimpseMinDistance = 0.000000;
	this->_glimpseMaxDistance = 0.000000;
	this->_killerGlimpseCooldown = 0.000000;
	this->_killerGlimpseDuration = 0.000000;
