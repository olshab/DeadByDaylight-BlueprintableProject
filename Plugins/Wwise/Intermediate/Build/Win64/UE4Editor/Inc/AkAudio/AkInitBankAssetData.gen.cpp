...
#include "AkAudio/Public/AkInitBankAssetData.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeAkInitBankAssetData() {}
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAkInitBankAssetData_Statics::Class_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "IncludePath", "AkInitBankAssetData.h" },
		{ "IsBlueprintBase", "true" },
		{ "ModuleRelativePath", "Public/AkInitBankAssetData.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAkInitBankAssetData_Statics::NewProp_PluginInfos_Inner = { "PluginInfos", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FAkPluginInfo, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAkInitBankAssetData_Statics::NewProp_PluginInfos_MetaData[] = {
		{ "Category", "AkInitBankAssetData" },
		{ "ModuleRelativePath", "Public/AkInitBankAssetData.h" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAkInitBankAssetData_Statics::NewProp_PluginInfos = { "PluginInfos", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAkInitBankAssetData, PluginInfos), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UAkInitBankAssetData_Statics::NewProp_PluginInfos_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAkInitBankAssetData_Statics::NewProp_PluginInfos_MetaData)) };
	...
	IMPLEMENT_CLASS(UAkInitBankAssetData, 1924651448);
