...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_AkAudio_AkSpeakerConfiguration_Hash() { return 1596054093U; }
	UEnum* Z_Construct_UEnum_AkAudio_AkSpeakerConfiguration()
	{
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				...
				{ "AkSpeakerConfiguration::ZeroEntry", (int64)AkSpeakerConfiguration::ZeroEntry },
			};
#if WITH_METADATA
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "ZeroEntry.Name", "AkSpeakerConfiguration::ZeroEntry" },
			};
#endif
