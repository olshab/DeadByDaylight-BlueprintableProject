...
static struct FScriptStruct_DBDUIViewsMobile_StaticRegisterNativesFMatchConfigDifficultyData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMatchConfigDifficultyData>(FName(TEXT("MatchConfigDifficultyData")));
	}
...
#endif
	const UE4CodeGen_Private::FSoftObjectPropertyParams Z_Construct_UScriptStruct_FMatchConfigDifficultyData_Statics::NewProp_DifficultyIcon = { "DifficultyIcon", nullptr, (EPropertyFlags)0x0014000000000005, UE4CodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMatchConfigDifficultyData, DifficultyIcon), Z_Construct_UClass_UPaperSprite_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FMatchConfigDifficultyData_Statics::NewProp_DifficultyIcon_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMatchConfigDifficultyData_Statics::NewProp_DifficultyIcon_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FMatchConfigDifficultyData_Hash() { return 1325883224U; }
