...
static struct FScriptStruct_DBDUIViewInterfaces_StaticRegisterNativesFMatchResultViewData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMatchResultViewData>(FName(TEXT("MatchResultViewData")));
	}
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMatchResultViewData_Statics::NewProp_KillerResult = { "KillerResult", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMatchResultViewData, KillerResult), Z_Construct_UEnum_DBDSharedTypes_EKillerMatchResult, METADATA_PARAMS(Z_Construct_UScriptStruct_FMatchResultViewData_Statics::NewProp_KillerResult_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMatchResultViewData_Statics::NewProp_KillerResult_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FMatchResultViewData_Hash() { return 1276635846U; }
