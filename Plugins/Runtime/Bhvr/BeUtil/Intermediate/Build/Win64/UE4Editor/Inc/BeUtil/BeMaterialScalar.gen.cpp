...
static struct FScriptStruct_BeUtil_StaticRegisterNativesFBeMaterialScalar
{
	...
	{
		UScriptStruct::DeferCppStructOps<FBeMaterialScalar>(FName(TEXT("BeMaterialScalar")));
	}
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FBeMaterialScalar_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBeMaterialScalar, Name), METADATA_PARAMS(Z_Construct_UScriptStruct_FBeMaterialScalar_Statics::NewProp_Name_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBeMaterialScalar_Statics::NewProp_Name_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FBeMaterialScalar_Statics::NewProp_Scalar = { "Scalar", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBeMaterialScalar, Scalar), METADATA_PARAMS(Z_Construct_UScriptStruct_FBeMaterialScalar_Statics::NewProp_Scalar_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBeMaterialScalar_Statics::NewProp_Scalar_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FBeMaterialScalar_Hash() { return 306075842U; }
