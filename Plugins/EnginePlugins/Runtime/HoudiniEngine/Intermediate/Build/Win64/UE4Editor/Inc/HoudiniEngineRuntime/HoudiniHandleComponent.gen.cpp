...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UHoudiniHandleComponent_Statics::NewProp_RSTParm = { "RSTParm", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniHandleComponent, RSTParm), Z_Construct_UClass_UHoudiniHandleParameter_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UHoudiniHandleComponent_Statics::NewProp_RSTParm_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniHandleComponent_Statics::NewProp_RSTParm_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UHoudiniHandleComponent_Statics::NewProp_RotOrderParm = { "RotOrderParm", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniHandleComponent, RotOrderParm), Z_Construct_UClass_UHoudiniHandleParameter_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UHoudiniHandleComponent_Statics::NewProp_RotOrderParm_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniHandleComponent_Statics::NewProp_RotOrderParm_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UHoudiniHandleComponent_Statics::NewProp_HandleType = { "HandleType", nullptr, (EPropertyFlags)0x0040000000000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniHandleComponent, HandleType), Z_Construct_UEnum_HoudiniEngineRuntime_EHoudiniHandleType, METADATA_PARAMS(Z_Construct_UClass_UHoudiniHandleComponent_Statics::NewProp_HandleType_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniHandleComponent_Statics::NewProp_HandleType_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UHoudiniHandleComponent_Statics::NewProp_HandleName = { "HandleName", nullptr, (EPropertyFlags)0x0040000000000005, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniHandleComponent, HandleName), METADATA_PARAMS(Z_Construct_UClass_UHoudiniHandleComponent_Statics::NewProp_HandleName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniHandleComponent_Statics::NewProp_HandleName_MetaData)) };
	...
	IMPLEMENT_CLASS(UHoudiniHandleComponent, 1948894011);
