...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UUITweenMaterialScalarProperties_Statics::NewProp_MaterialInstance_MetaData[] = {
		{ "Category", "UITweenMaterialScalarProperties" },
		{ "ModuleRelativePath", "Public/UITweenMaterialScalarProperties.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UUITweenMaterialScalarProperties_Statics::NewProp_MaterialInstance = { "MaterialInstance", nullptr, (EPropertyFlags)0x0010000000002005, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUITweenMaterialScalarProperties, MaterialInstance), Z_Construct_UClass_UMaterialInstanceDynamic_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UUITweenMaterialScalarProperties_Statics::NewProp_MaterialInstance_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUITweenMaterialScalarProperties_Statics::NewProp_MaterialInstance_MetaData)) };
	...
	IMPLEMENT_CLASS(UUITweenMaterialScalarProperties, 706046961);
