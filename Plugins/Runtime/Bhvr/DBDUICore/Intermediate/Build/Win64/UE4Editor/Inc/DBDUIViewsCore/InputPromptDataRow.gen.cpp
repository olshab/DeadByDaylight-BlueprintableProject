...
static_assert(std::is_polymorphic<FInputPromptDataRow>() == std::is_polymorphic<FTableRowBase>(), "USTRUCT FInputPromptDataRow cannot be polymorphic unless super FTableRowBase is polymorphic");
...
static struct FScriptStruct_DBDUIViewsCore_StaticRegisterNativesFInputPromptDataRow
{
	...
	{
		UScriptStruct::DeferCppStructOps<FInputPromptDataRow>(FName(TEXT("InputPromptDataRow")));
	}
...
#endif
	const UE4CodeGen_Private::FTextPropertyParams Z_Construct_UScriptStruct_FInputPromptDataRow_Statics::NewProp_InputLabel = { "InputLabel", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FInputPromptDataRow, InputLabel), METADATA_PARAMS(Z_Construct_UScriptStruct_FInputPromptDataRow_Statics::NewProp_InputLabel_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInputPromptDataRow_Statics::NewProp_InputLabel_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FInputPromptDataRow_Statics::NewProp_PromptTexture = { "PromptTexture", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FInputPromptDataRow, PromptTexture), Z_Construct_UClass_UTexture2D_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FInputPromptDataRow_Statics::NewProp_PromptTexture_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInputPromptDataRow_Statics::NewProp_PromptTexture_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FInputPromptDataRow_Statics::NewProp_ShowLabel = { "ShowLabel", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FInputPromptDataRow), &Z_Construct_UScriptStruct_FInputPromptDataRow_Statics::NewProp_ShowLabel_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FInputPromptDataRow_Statics::NewProp_ShowLabel_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInputPromptDataRow_Statics::NewProp_ShowLabel_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FInputPromptDataRow_Hash() { return 2471096722U; }
