...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UHoudiniInputSplineComponent_Statics::NewProp_SplineResolution = { "SplineResolution", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniInputSplineComponent, SplineResolution), METADATA_PARAMS(Z_Construct_UClass_UHoudiniInputSplineComponent_Statics::NewProp_SplineResolution_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniInputSplineComponent_Statics::NewProp_SplineResolution_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UHoudiniInputSplineComponent_Statics::NewProp_SplineControlPoints = { "SplineControlPoints", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniInputSplineComponent, SplineControlPoints), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UHoudiniInputSplineComponent_Statics::NewProp_SplineControlPoints_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniInputSplineComponent_Statics::NewProp_SplineControlPoints_MetaData)) };
	...
	IMPLEMENT_CLASS(UHoudiniInputSplineComponent, 1268356558);
