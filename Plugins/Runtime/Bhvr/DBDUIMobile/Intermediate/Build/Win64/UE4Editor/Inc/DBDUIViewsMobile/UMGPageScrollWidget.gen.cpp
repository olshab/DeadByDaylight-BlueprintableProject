...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UUMGPageScrollWidget_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UUMGPageScrollWidget_HandlePageButtonClicked, "HandlePageButtonClicked" }, // 542128929
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FSoftClassPropertyParams Z_Construct_UClass_UUMGPageScrollWidget_Statics::NewProp__pageButtonWidgetClass = { "_pageButtonWidgetClass", nullptr, (EPropertyFlags)0x0024080002000005, UE4CodeGen_Private::EPropertyGenFlags::SoftClass, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUMGPageScrollWidget, _pageButtonWidgetClass), Z_Construct_UClass_UUMGScrollListPageButton_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UUMGPageScrollWidget_Statics::NewProp__pageButtonWidgetClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUMGPageScrollWidget_Statics::NewProp__pageButtonWidgetClass_MetaData)) };
	...
	IMPLEMENT_CLASS(UUMGPageScrollWidget, 1486907671);
