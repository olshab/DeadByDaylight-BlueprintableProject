...
static struct FScriptStruct_AkAudio_StaticRegisterNativesFAkMainOutputSettings
{
	...
	struct Z_Construct_UScriptStruct_FAkMainOutputSettings_Statics
	{
		...
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_PanningRule_Underlying;
#if WITH_METADATA
		...
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_ChannelConfigType_Underlying;
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FAkMainOutputSettings_Statics::NewProp_PanningRule_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FAkMainOutputSettings_Statics::NewProp_ChannelConfigType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FAkMainOutputSettings_Hash() { return 3863970577U; }
