...
// End Cross Module References
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UAkAudioEventData_Statics::NewProp_LocalizedMedia_ValueProp = { "LocalizedMedia", nullptr, (EPropertyFlags)0x0000000020000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, Z_Construct_UClass_UAkAssetDataSwitchContainer_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UAkAudioEventData_Statics::NewProp_LocalizedMedia_Key_KeyProp = { "LocalizedMedia_Key", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAkAudioEventData_Statics::NewProp_LocalizedMedia_MetaData[] = {
		{ "ModuleRelativePath", "Public/AkAudioEventData.h" },
	};
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UClass_UAkAudioEventData_Statics::NewProp_LocalizedMedia = { "LocalizedMedia", nullptr, (EPropertyFlags)0x0010000020000000, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAkAudioEventData, LocalizedMedia_DEPRECATED), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UAkAudioEventData_Statics::NewProp_LocalizedMedia_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAkAudioEventData_Statics::NewProp_LocalizedMedia_MetaData)) };
	...
	IMPLEMENT_CLASS(UAkAudioEventData, 1360596593);
