...
void UBatchMeshCommands::AddGroup(const FMaterialNamedGroup group)
{
...
{
	this->Groups = TArray<FMaterialNamedGroup>();
	this->TargetMeshes = TArray<FMaterialHelperOriginalMeshState>();
