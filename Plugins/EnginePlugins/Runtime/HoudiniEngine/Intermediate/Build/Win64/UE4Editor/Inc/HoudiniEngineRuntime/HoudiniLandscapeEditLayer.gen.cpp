...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UHoudiniLandscapeEditLayer_Statics::NewProp_LandscapeSoftPtr_MetaData[] = {
		{ "Category", "HoudiniLandscapeEditLayer" },
		{ "ModuleRelativePath", "Public/HoudiniLandscapeEditLayer.h" },
	};
#endif
	const UE4CodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UHoudiniLandscapeEditLayer_Statics::NewProp_LandscapeSoftPtr = { "LandscapeSoftPtr", nullptr, (EPropertyFlags)0x0014000000000005, UE4CodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniLandscapeEditLayer, LandscapeSoftPtr), Z_Construct_UClass_ALandscapeProxy_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UHoudiniLandscapeEditLayer_Statics::NewProp_LandscapeSoftPtr_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniLandscapeEditLayer_Statics::NewProp_LandscapeSoftPtr_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UHoudiniLandscapeEditLayer_Statics::NewProp_LayerName = { "LayerName", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniLandscapeEditLayer, LayerName), METADATA_PARAMS(Z_Construct_UClass_UHoudiniLandscapeEditLayer_Statics::NewProp_LayerName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniLandscapeEditLayer_Statics::NewProp_LayerName_MetaData)) };
	...
	IMPLEMENT_CLASS(UHoudiniLandscapeEditLayer, 2914824431);
