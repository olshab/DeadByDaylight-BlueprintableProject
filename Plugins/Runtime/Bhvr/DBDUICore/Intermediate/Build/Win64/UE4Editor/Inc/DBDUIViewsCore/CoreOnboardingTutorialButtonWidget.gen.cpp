...
// Cross Module References
	...
	DBDUIVIEWSCORE_API UFunction* Z_Construct_UDelegateFunction_DBDUIViewsCore_OnSetDataAnimationCompleteDelegate__DelegateSignature();
...
// End Cross Module References
	...
	void UCoreOnboardingTutorialButtonWidget::SetData(FOnboardingTutorialButtonViewData const& viewDataNew, bool isRefreshingWithAnimation)
	{
		CoreOnboardingTutorialButtonWidget_eventSetData_Parms Parms;
		Parms.viewDataNew=viewDataNew;
	...
	static FName NAME_UCoreOnboardingTutorialButtonWidget_SetIsKillSwitch = FName(TEXT("SetIsKillSwitch"));
	void UCoreOnboardingTutorialButtonWidget::SetIsKillSwitch(bool isKillSwitch)
	{
		CoreOnboardingTutorialButtonWidget_eventSetIsKillSwitch_Parms Parms;
		Parms.isKillSwitch=isKillSwitch ? true : false;
		ProcessEvent(FindFunctionChecked(NAME_UCoreOnboardingTutorialButtonWidget_SetIsKillSwitch),&Parms);
	}
	...
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_viewDataNew_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_viewDataNew;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UCoreOnboardingTutorialButtonWidget_SetData_Statics::NewProp_viewDataNew_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UCoreOnboardingTutorialButtonWidget_SetData_Statics::NewProp_viewDataNew = { "viewDataNew", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(CoreOnboardingTutorialButtonWidget_eventSetData_Parms, viewDataNew), Z_Construct_UScriptStruct_FOnboardingTutorialButtonViewData, METADATA_PARAMS(Z_Construct_UFunction_UCoreOnboardingTutorialButtonWidget_SetData_Statics::NewProp_viewDataNew_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UCoreOnboardingTutorialButtonWidget_SetData_Statics::NewProp_viewDataNew_MetaData)) };
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UCoreOnboardingTutorialButtonWidget_SetData_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UCoreOnboardingTutorialButtonWidget_SetData_Statics::NewProp_viewDataNew,
	...
	struct Z_Construct_UFunction_UCoreOnboardingTutorialButtonWidget_SetIsKillSwitch_Statics
	{
	...
	void Z_Construct_UFunction_UCoreOnboardingTutorialButtonWidget_SetIsKillSwitch_Statics::NewProp_isKillSwitch_SetBit(void* Obj)
	{
		((CoreOnboardingTutorialButtonWidget_eventSetIsKillSwitch_Parms*)Obj)->isKillSwitch = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UCoreOnboardingTutorialButtonWidget_SetIsKillSwitch_Statics::NewProp_isKillSwitch = { "isKillSwitch", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(CoreOnboardingTutorialButtonWidget_eventSetIsKillSwitch_Parms), &Z_Construct_UFunction_UCoreOnboardingTutorialButtonWidget_SetIsKillSwitch_Statics::NewProp_isKillSwitch_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UCoreOnboardingTutorialButtonWidget_SetIsKillSwitch_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UCoreOnboardingTutorialButtonWidget_SetIsKillSwitch_Statics::NewProp_isKillSwitch,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UCoreOnboardingTutorialButtonWidget_SetIsKillSwitch_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/CoreOnboardingTutorialButtonWidget.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UCoreOnboardingTutorialButtonWidget_SetIsKillSwitch_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget, nullptr, "SetIsKillSwitch", nullptr, nullptr, sizeof(CoreOnboardingTutorialButtonWidget_eventSetIsKillSwitch_Parms), Z_Construct_UFunction_UCoreOnboardingTutorialButtonWidget_SetIsKillSwitch_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCoreOnboardingTutorialButtonWidget_SetIsKillSwitch_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020800, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UCoreOnboardingTutorialButtonWidget_SetIsKillSwitch_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UCoreOnboardingTutorialButtonWidget_SetIsKillSwitch_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UCoreOnboardingTutorialButtonWidget_SetIsKillSwitch()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UCoreOnboardingTutorialButtonWidget_SetIsKillSwitch_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UCoreOnboardingTutorialButtonWidget_OnRewardClicked, "OnRewardClicked" }, // 1470150324
		{ &Z_Construct_UFunction_UCoreOnboardingTutorialButtonWidget_OnRewardPressed, "OnRewardPressed" }, // 996414930
		{ &Z_Construct_UFunction_UCoreOnboardingTutorialButtonWidget_OnRewardReleased, "OnRewardReleased" }, // 2308139080
		{ &Z_Construct_UFunction_UCoreOnboardingTutorialButtonWidget_SetData, "SetData" }, // 2098679847
		{ &Z_Construct_UFunction_UCoreOnboardingTutorialButtonWidget_SetIsKillSwitch, "SetIsKillSwitch" }, // 703621297
		{ &Z_Construct_UFunction_UCoreOnboardingTutorialButtonWidget_SetUIEnabled, "SetUIEnabled" }, // 4254147919
...
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget_Statics::NewProp_OnSetDataAnimationCompleteDelegate = { "OnSetDataAnimationCompleteDelegate", nullptr, (EPropertyFlags)0x0010000000080005, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCoreOnboardingTutorialButtonWidget, OnSetDataAnimationCompleteDelegate), Z_Construct_UDelegateFunction_DBDUIViewsCore_OnSetDataAnimationCompleteDelegate__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget_Statics::NewProp_OnSetDataAnimationCompleteDelegate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget_Statics::NewProp_OnSetDataAnimationCompleteDelegate_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget_Statics::NewProp_UnavailablePressedSfx = { "UnavailablePressedSfx", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCoreOnboardingTutorialButtonWidget, UnavailablePressedSfx), Z_Construct_UClass_UAkAudioEvent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget_Statics::NewProp_UnavailablePressedSfx_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget_Statics::NewProp_UnavailablePressedSfx_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget_Statics::NewProp_TitleText = { "TitleText", nullptr, (EPropertyFlags)0x002008000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCoreOnboardingTutorialButtonWidget, TitleText), Z_Construct_UClass_UDBDTextBlock_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget_Statics::NewProp_TitleText_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget_Statics::NewProp_TitleText_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget_Statics::NewProp_DescriptionText = { "DescriptionText", nullptr, (EPropertyFlags)0x002008000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCoreOnboardingTutorialButtonWidget, DescriptionText), Z_Construct_UClass_UDBDTextBlock_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget_Statics::NewProp_DescriptionText_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget_Statics::NewProp_DescriptionText_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget_Statics::NewProp_RewardsText = { "RewardsText", nullptr, (EPropertyFlags)0x002008000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCoreOnboardingTutorialButtonWidget, RewardsText), Z_Construct_UClass_UDBDTextBlock_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget_Statics::NewProp_RewardsText_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget_Statics::NewProp_RewardsText_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget_Statics::NewProp_StateSwitcher = { "StateSwitcher", nullptr, (EPropertyFlags)0x002008000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCoreOnboardingTutorialButtonWidget, StateSwitcher), Z_Construct_UClass_UWidgetSwitcher_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget_Statics::NewProp_StateSwitcher_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget_Statics::NewProp_StateSwitcher_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget_Statics::NewProp_LockedImage = { "LockedImage", nullptr, (EPropertyFlags)0x002008000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCoreOnboardingTutorialButtonWidget, LockedImage), Z_Construct_UClass_UDBDImage_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget_Statics::NewProp_LockedImage_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget_Statics::NewProp_LockedImage_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget_Statics::NewProp_CompletedImage = { "CompletedImage", nullptr, (EPropertyFlags)0x002008000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCoreOnboardingTutorialButtonWidget, CompletedImage), Z_Construct_UClass_UDBDImage_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget_Statics::NewProp_CompletedImage_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget_Statics::NewProp_CompletedImage_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget_Statics::NewProp_ViewData = { "ViewData", nullptr, (EPropertyFlags)0x0020080000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCoreOnboardingTutorialButtonWidget, ViewData), Z_Construct_UScriptStruct_FOnboardingTutorialButtonViewData, METADATA_PARAMS(Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget_Statics::NewProp_ViewData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCoreOnboardingTutorialButtonWidget_Statics::NewProp_ViewData_MetaData)) };
	...
	IMPLEMENT_CLASS(UCoreOnboardingTutorialButtonWidget, 2169633392);
