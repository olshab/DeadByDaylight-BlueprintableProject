...
// End Cross Module References
	DEFINE_FUNCTION(ITestBuildFlagViewInterface::execUpdateWidget)
	{
		...
		P_GET_ENUM(ETestBuildFlagPosition,Z_Param_testBuildFlagPosition);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->UpdateWidget_Implementation(ETestBuildType(Z_Param_testBuildType),ETestBuildFlagPosition(Z_Param_testBuildFlagPosition));
		P_NATIVE_END;
	}
	...
	struct Z_Construct_UFunction_UTestBuildFlagViewInterface_UpdateWidget_Statics
	{
		...
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_testBuildFlagPosition_Underlying;
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_testBuildFlagPosition;
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UTestBuildFlagViewInterface_UpdateWidget_Statics::NewProp_testBuildFlagPosition_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UTestBuildFlagViewInterface_UpdateWidget_Statics::NewProp_testBuildFlagPosition = { "testBuildFlagPosition", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(TestBuildFlagViewInterface_eventUpdateWidget_Parms, testBuildFlagPosition), Z_Construct_UEnum_DBDUIViewInterfaces_ETestBuildFlagPosition, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UTestBuildFlagViewInterface_UpdateWidget_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UTestBuildFlagViewInterface_UpdateWidget_Statics::NewProp_testBuildFlagPosition_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UTestBuildFlagViewInterface_UpdateWidget_Statics::NewProp_testBuildFlagPosition,
	};
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UTestBuildFlagViewInterface_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UTestBuildFlagViewInterface_UpdateWidget, "UpdateWidget" }, // 24747102
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UTestBuildFlagViewInterface, 3446188397);
	...
	void ITestBuildFlagViewInterface::Execute_UpdateWidget(UObject* O, ETestBuildType testBuildType, ETestBuildFlagPosition testBuildFlagPosition)
	{
		check(O != NULL);
		...
		{
			I->UpdateWidget_Implementation(testBuildType,testBuildFlagPosition);
		}
	}
