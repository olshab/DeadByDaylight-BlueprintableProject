...
void AK26CrowProjectile::Authority_OnScoutingOverlapEnd(UPrimitiveComponent* overlappedComp, AActor* otherActor, UPrimitiveComponent* otherComp, int32 otherBodyIndex)
{
...
{
	this->_projectileStateDetails = TMap<EK26ProjectileState, FK26ProjectileStateDetails>();
	this->_onPathMovementSpeedModifierCurve = NULL;
	this->_offPathMovementSpeedModifierCurve = NULL;
	this->_projectileOffPathCurveDuration = 1.000000;
	this->_path = TArray<FVector>();
	...
	this->_visualSkeletalMeshComponent = CreateDefaultSubobject<UDBDSkeletalMeshComponentBudgeted>(TEXT("Visual"));
	...
	this->_lockersWithSurvivorsInitiallyOnKillerInstinctRadius = TArray<ALocker*>();
	this->_fireTime = 0.000000;
	this->_currentDistanceAlongSpline = 0.000000;
	this->_offPathTime = 0.000000;
