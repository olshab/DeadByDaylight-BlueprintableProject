...
static struct FScriptStruct_DBDUIViewInterfaces_StaticRegisterNativesFHudObjectivesViewData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FHudObjectivesViewData>(FName(TEXT("HudObjectivesViewData")));
	}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_requiredActivatedGeneratorCount_MetaData[];
#endif
		static const UE4CodeGen_Private::FIntPropertyParams NewProp_requiredActivatedGeneratorCount;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FHudObjectivesViewData_Statics::NewProp_requiredActivatedGeneratorCount_MetaData[] = {
		{ "Category", "HudObjectivesViewData" },
		{ "ModuleRelativePath", "Public/HudObjectivesViewData.h" },
	};
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FHudObjectivesViewData_Statics::NewProp_requiredActivatedGeneratorCount = { "requiredActivatedGeneratorCount", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FHudObjectivesViewData, requiredActivatedGeneratorCount), METADATA_PARAMS(Z_Construct_UScriptStruct_FHudObjectivesViewData_Statics::NewProp_requiredActivatedGeneratorCount_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHudObjectivesViewData_Statics::NewProp_requiredActivatedGeneratorCount_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FHudObjectivesViewData_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FHudObjectivesViewData_Statics::NewProp_requiredActivatedGeneratorCount,
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FHudObjectivesViewData_Hash() { return 1831096813U; }
