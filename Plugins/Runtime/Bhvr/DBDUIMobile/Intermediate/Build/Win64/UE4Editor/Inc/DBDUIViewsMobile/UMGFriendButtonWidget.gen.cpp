...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UUMGFriendButtonWidget_Statics::NewProp_NonInteractableButtonStatePanel = { "NonInteractableButtonStatePanel", nullptr, (EPropertyFlags)0x002008000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUMGFriendButtonWidget, NonInteractableButtonStatePanel), Z_Construct_UClass_UCanvasPanel_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UUMGFriendButtonWidget_Statics::NewProp_NonInteractableButtonStatePanel_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUMGFriendButtonWidget_Statics::NewProp_NonInteractableButtonStatePanel_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UUMGFriendButtonWidget_Statics::NewProp_NonInteractableExplanationText = { "NonInteractableExplanationText", nullptr, (EPropertyFlags)0x002008000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUMGFriendButtonWidget, NonInteractableExplanationText), Z_Construct_UClass_UTextBlock_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UUMGFriendButtonWidget_Statics::NewProp_NonInteractableExplanationText_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUMGFriendButtonWidget_Statics::NewProp_NonInteractableExplanationText_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UUMGFriendButtonWidget_Statics::NewProp_NonInteractableActionText = { "NonInteractableActionText", nullptr, (EPropertyFlags)0x002008000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUMGFriendButtonWidget, NonInteractableActionText), Z_Construct_UClass_UTextBlock_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UUMGFriendButtonWidget_Statics::NewProp_NonInteractableActionText_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUMGFriendButtonWidget_Statics::NewProp_NonInteractableActionText_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UClass_UUMGFriendButtonWidget_Statics::NewProp__nonInteractableImages = { "_nonInteractableImages", nullptr, (EPropertyFlags)0x0020080002000005, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUMGFriendButtonWidget, _nonInteractableImages), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UUMGFriendButtonWidget_Statics::NewProp__nonInteractableImages_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUMGFriendButtonWidget_Statics::NewProp__nonInteractableImages_MetaData)) };
	...
	IMPLEMENT_CLASS(UUMGFriendButtonWidget, 3167849096);
