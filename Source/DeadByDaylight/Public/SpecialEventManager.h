...
class USpecialEventCustomizationsComponent;
...
private:
	...
	USpecialEventsContainer* _eventsContainer;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Transient, meta=(AllowPrivateAccess=true))
	USpecialEventCustomizationsComponent* _customizationsComponent;
...
public:
	...
	UFUNCTION(BlueprintPure)
	static bool GetSpecialEvent(const UObject* worldContextObject, const FName eventId, FCombinedSpecialEventData& outSpecialEventData);
