#include "ArchiveJournalSubPresenter.h"

void UArchiveJournalSubPresenter::OnVignetteSelected(const FString& vignetteId)
{
...
UArchiveJournalSubPresenter::UArchiveJournalSubPresenter()
{
	this->_archiveJournalWidget = NULL;
}
