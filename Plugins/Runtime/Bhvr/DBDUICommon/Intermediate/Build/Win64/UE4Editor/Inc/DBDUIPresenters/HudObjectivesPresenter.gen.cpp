...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_UHudObjectivesPresenter_Statics::NewProp_CoreHudObjectivesWidgetClass = { "CoreHudObjectivesWidgetClass", nullptr, (EPropertyFlags)0x0014000000000005, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHudObjectivesPresenter, CoreHudObjectivesWidgetClass), Z_Construct_UClass_UUserWidget_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_UHudObjectivesPresenter_Statics::NewProp_CoreHudObjectivesWidgetClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHudObjectivesPresenter_Statics::NewProp_CoreHudObjectivesWidgetClass_MetaData)) };
	...
	IMPLEMENT_CLASS(UHudObjectivesPresenter, 105728943);
