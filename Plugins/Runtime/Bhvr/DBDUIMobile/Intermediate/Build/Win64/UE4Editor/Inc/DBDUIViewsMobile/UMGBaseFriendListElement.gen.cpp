...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UUMGBaseFriendListElement_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UUMGBaseFriendListElement_TriggerActionOnThisFriend, "TriggerActionOnThisFriend" }, // 3753010735
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UUMGBaseFriendListElement_Statics::NewProp_FriendName = { "FriendName", nullptr, (EPropertyFlags)0x002008000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUMGBaseFriendListElement, FriendName), Z_Construct_UClass_UTextBlock_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UUMGBaseFriendListElement_Statics::NewProp_FriendName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUMGBaseFriendListElement_Statics::NewProp_FriendName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UUMGBaseFriendListElement_Statics::NewProp_FriendStatus = { "FriendStatus", nullptr, (EPropertyFlags)0x002008000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUMGBaseFriendListElement, FriendStatus), Z_Construct_UClass_UTextBlock_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UUMGBaseFriendListElement_Statics::NewProp_FriendStatus_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUMGBaseFriendListElement_Statics::NewProp_FriendStatus_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UUMGBaseFriendListElement_Statics::NewProp_ContextualMenuPosition = { "ContextualMenuPosition", nullptr, (EPropertyFlags)0x002008000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUMGBaseFriendListElement, ContextualMenuPosition), Z_Construct_UClass_UNamedSlot_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UUMGBaseFriendListElement_Statics::NewProp_ContextualMenuPosition_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUMGBaseFriendListElement_Statics::NewProp_ContextualMenuPosition_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UUMGBaseFriendListElement_Statics::NewProp__cachedFriendData = { "_cachedFriendData", nullptr, (EPropertyFlags)0x0020080000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUMGBaseFriendListElement, _cachedFriendData), Z_Construct_UScriptStruct_FAtlantaFriendUIData, METADATA_PARAMS(Z_Construct_UClass_UUMGBaseFriendListElement_Statics::NewProp__cachedFriendData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUMGBaseFriendListElement_Statics::NewProp__cachedFriendData_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UUMGBaseFriendListElement, 1324591315);
