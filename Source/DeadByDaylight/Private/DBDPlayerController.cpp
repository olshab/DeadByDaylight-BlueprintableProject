...
void ADBDPlayerController::Server_ClientTimeSinceLastLoadingProgress_Implementation(float lastProgression)
{
...
void ADBDPlayerController::Client_SetPlayerFinishStats_Implementation(const FPlayerFinishStats& stats)
{
