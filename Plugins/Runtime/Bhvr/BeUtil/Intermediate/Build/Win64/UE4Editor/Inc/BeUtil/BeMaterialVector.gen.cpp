...
static struct FScriptStruct_BeUtil_StaticRegisterNativesFBeMaterialVector
{
	...
	{
		UScriptStruct::DeferCppStructOps<FBeMaterialVector>(FName(TEXT("BeMaterialVector")));
	}
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FBeMaterialVector_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBeMaterialVector, Name), METADATA_PARAMS(Z_Construct_UScriptStruct_FBeMaterialVector_Statics::NewProp_Name_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBeMaterialVector_Statics::NewProp_Name_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FBeMaterialVector_Statics::NewProp_Vector = { "Vector", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBeMaterialVector, Vector), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(Z_Construct_UScriptStruct_FBeMaterialVector_Statics::NewProp_Vector_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBeMaterialVector_Statics::NewProp_Vector_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FBeMaterialVector_Hash() { return 2013646163U; }
