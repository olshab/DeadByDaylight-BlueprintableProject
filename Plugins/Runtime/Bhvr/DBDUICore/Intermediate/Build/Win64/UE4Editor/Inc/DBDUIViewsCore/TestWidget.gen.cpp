...
// End Cross Module References
	...
	{
		P_GET_UBOOL(Z_Param_showWorkbenchNew);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->SetShowWorkbench(Z_Param_showWorkbenchNew);
		P_NATIVE_END;
	}
	...
	struct Z_Construct_UFunction_UTestWidget_SetShowWorkbench_Statics
	{
		...
		{
			bool showWorkbenchNew;
		};
		static void NewProp_showWorkbenchNew_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_showWorkbenchNew;
	...
	void Z_Construct_UFunction_UTestWidget_SetShowWorkbench_Statics::NewProp_showWorkbenchNew_SetBit(void* Obj)
	{
		((TestWidget_eventSetShowWorkbench_Parms*)Obj)->showWorkbenchNew = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UTestWidget_SetShowWorkbench_Statics::NewProp_showWorkbenchNew = { "showWorkbenchNew", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(TestWidget_eventSetShowWorkbench_Parms), &Z_Construct_UFunction_UTestWidget_SetShowWorkbench_Statics::NewProp_showWorkbenchNew_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UTestWidget_SetShowWorkbench_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UTestWidget_SetShowWorkbench_Statics::NewProp_showWorkbenchNew,
	};
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UTestWidget_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UTestWidget_SetShowWorkbench, "SetShowWorkbench" }, // 3780627229
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UTestWidget_Statics::NewProp_Workbench = { "Workbench", nullptr, (EPropertyFlags)0x002008000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTestWidget, Workbench), Z_Construct_UClass_UPanelWidget_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UTestWidget_Statics::NewProp_Workbench_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTestWidget_Statics::NewProp_Workbench_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UTestWidget, 1010955250);
