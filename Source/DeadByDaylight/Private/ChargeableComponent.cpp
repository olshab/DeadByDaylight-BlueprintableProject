...
void UChargeableComponent::Multicast_SetPermanentCharge_Implementation(float chargePercent)
{
...
void UChargeableComponent::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	...
	DOREPLIFETIME(UChargeableComponent, _isChargeBlocked);
}
...
UChargeableComponent::UChargeableComponent()
{
	...
	this->StartingChargePercent = 0.000000;
