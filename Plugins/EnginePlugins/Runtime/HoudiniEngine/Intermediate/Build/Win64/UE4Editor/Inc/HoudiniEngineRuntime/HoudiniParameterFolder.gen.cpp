...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UHoudiniParameterFolder_Statics::NewProp_FolderType = { "FolderType", nullptr, (EPropertyFlags)0x0040000000000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniParameterFolder, FolderType), Z_Construct_UEnum_HoudiniEngineRuntime_EHoudiniFolderParameterType, METADATA_PARAMS(Z_Construct_UClass_UHoudiniParameterFolder_Statics::NewProp_FolderType_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniParameterFolder_Statics::NewProp_FolderType_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UHoudiniParameterFolder_Statics::NewProp_bChosen = { "bChosen", nullptr, (EPropertyFlags)0x0040000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UHoudiniParameterFolder), &Z_Construct_UClass_UHoudiniParameterFolder_Statics::NewProp_bChosen_SetBit, METADATA_PARAMS(Z_Construct_UClass_UHoudiniParameterFolder_Statics::NewProp_bChosen_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniParameterFolder_Statics::NewProp_bChosen_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UHoudiniParameterFolder_Statics::NewProp_ChildCounter = { "ChildCounter", nullptr, (EPropertyFlags)0x0040000000000005, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniParameterFolder, ChildCounter), METADATA_PARAMS(Z_Construct_UClass_UHoudiniParameterFolder_Statics::NewProp_ChildCounter_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniParameterFolder_Statics::NewProp_ChildCounter_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UHoudiniParameterFolder_Statics::NewProp_bIsContentShown = { "bIsContentShown", nullptr, (EPropertyFlags)0x0040000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UHoudiniParameterFolder), &Z_Construct_UClass_UHoudiniParameterFolder_Statics::NewProp_bIsContentShown_SetBit, METADATA_PARAMS(Z_Construct_UClass_UHoudiniParameterFolder_Statics::NewProp_bIsContentShown_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniParameterFolder_Statics::NewProp_bIsContentShown_MetaData)) };
	...
	IMPLEMENT_CLASS(UHoudiniParameterFolder, 571686331);
