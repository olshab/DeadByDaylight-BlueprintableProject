...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UUMGScrollListPageButton_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UUMGScrollListPageButton_HandleActionButtonClick, "HandleActionButtonClick" }, // 1413772732
...
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UUMGScrollListPageButton_Statics::NewProp_OnClicked = { "OnClicked", nullptr, (EPropertyFlags)0x0010000010080005, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUMGScrollListPageButton, OnClicked), Z_Construct_UDelegateFunction_DBDUIViewsMobile_OnScrollListPageButtonClicked__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UUMGScrollListPageButton_Statics::NewProp_OnClicked_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUMGScrollListPageButton_Statics::NewProp_OnClicked_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UUMGScrollListPageButton_Statics::NewProp_PageIndex = { "PageIndex", nullptr, (EPropertyFlags)0x0010000000002005, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUMGScrollListPageButton, PageIndex), METADATA_PARAMS(Z_Construct_UClass_UUMGScrollListPageButton_Statics::NewProp_PageIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUMGScrollListPageButton_Statics::NewProp_PageIndex_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UUMGScrollListPageButton, 2035283647);
