...
void ABearTrap::Authority_ImposeRevealAuraEffect(ACamperPlayer* survivor)
{
...
ABearTrap::ABearTrap()
{
	...
	this->_revealWhileTrappedStatusEffectClass = NULL;
	...
	this->_honingStoneStatusEffect = NULL;
}
