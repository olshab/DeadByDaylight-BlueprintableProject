...
// Cross Module References
	...
	DBDSHAREDTYPES_API UScriptStruct* Z_Construct_UScriptStruct_FScreenIndicatorViewData();
...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UCoreScreenIndicatorWidget_Statics::NewProp_InactiveTime = { "InactiveTime", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCoreScreenIndicatorWidget, InactiveTime), METADATA_PARAMS(Z_Construct_UClass_UCoreScreenIndicatorWidget_Statics::NewProp_InactiveTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCoreScreenIndicatorWidget_Statics::NewProp_InactiveTime_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCoreScreenIndicatorWidget_Statics::NewProp_IndicatorPadding = { "IndicatorPadding", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCoreScreenIndicatorWidget, IndicatorPadding), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(Z_Construct_UClass_UCoreScreenIndicatorWidget_Statics::NewProp_IndicatorPadding_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCoreScreenIndicatorWidget_Statics::NewProp_IndicatorPadding_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCoreScreenIndicatorWidget_Statics::NewProp_DistanceClamping = { "DistanceClamping", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCoreScreenIndicatorWidget, DistanceClamping), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(Z_Construct_UClass_UCoreScreenIndicatorWidget_Statics::NewProp_DistanceClamping_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCoreScreenIndicatorWidget_Statics::NewProp_DistanceClamping_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UCoreScreenIndicatorWidget_Statics::NewProp_MinDistanceRatio = { "MinDistanceRatio", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCoreScreenIndicatorWidget, MinDistanceRatio), METADATA_PARAMS(Z_Construct_UClass_UCoreScreenIndicatorWidget_Statics::NewProp_MinDistanceRatio_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCoreScreenIndicatorWidget_Statics::NewProp_MinDistanceRatio_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UCoreScreenIndicatorWidget, 3476802574);
