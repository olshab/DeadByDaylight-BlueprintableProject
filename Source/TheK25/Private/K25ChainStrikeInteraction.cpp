...
void UK25ChainStrikeInteraction::Server_UpdateCameraViewTargetForObservers_Implementation(EChainStrikeCameraViewTarget newViewTarget)
{
...
bool UK25ChainStrikeInteraction::Server_RemoveStateTagFromPlayer_Validate(FGameplayTag tag)
{
	return true;
}
...
bool UK25ChainStrikeInteraction::Server_AddStateTagToPlayer_Validate(FGameplayTag tag)
{
	return true;
}
