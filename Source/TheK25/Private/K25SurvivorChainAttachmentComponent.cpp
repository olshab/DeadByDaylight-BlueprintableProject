...
UK25SurvivorChainAttachmentComponent::UK25SurvivorChainAttachmentComponent()
{
	...
	this->_survivorAnchorData = TArray<FK25SurvivorChainAttachmentData>();
	this->_survivorChainRotationStrategyClass = UK25SurvivorChainRotationStrategy::StaticClass();
	this->_interruptableInteractionClasses = TArray<TSubclassOf<UInteractionDefinition>>();
	this->_chainAttachmentAnchors = TArray<AK25SurvivorChainAttachmentAnchor*>();
	this->_chainsAttached = TArray<TWeakObjectPtr<AK25Chain>>();
