...
UGameplayTagContainerComponent* AInteractable::GetObjectState() const
{
	return NULL;
}
...
AInteractable::AInteractable()
{
	...
	this->_interactors = TArray<UInteractor*>();
	this->_transformOptimizer = CreateDefaultSubobject<UInteractableTransformOptimizer>(TEXT("InteractableOptimizer"));
	this->_zoneToInteractions = TMap<UPrimitiveComponent*, FInteractionArray>();
	this->_interactableObjectState = CreateDefaultSubobject<UGameplayTagContainerComponent>(TEXT("InteractableObjectState"));
}
