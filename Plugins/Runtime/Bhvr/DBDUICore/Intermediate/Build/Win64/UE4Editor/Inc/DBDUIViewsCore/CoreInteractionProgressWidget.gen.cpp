...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp__hemorrhageAnimationIsCompleteDelegate_MetaData[];
#endif
		static const UE4CodeGen_Private::FMulticastDelegatePropertyParams NewProp__hemorrhageAnimationIsCompleteDelegate;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCoreInteractionProgressWidget_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCoreInteractionProgressWidget_SetProficiencies, "SetProficiencies" }, // 2429107961
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UCoreInteractionProgressWidget_Statics::NewProp_Proficiencies = { "Proficiencies", nullptr, (EPropertyFlags)0x002008800000000d, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCoreInteractionProgressWidget, Proficiencies), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UCoreInteractionProgressWidget_Statics::NewProp_Proficiencies_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCoreInteractionProgressWidget_Statics::NewProp_Proficiencies_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UCoreInteractionProgressWidget_Statics::NewProp__hemorrhageAnimationIsCompleteDelegate_MetaData[] = {
		{ "AllowPrivateAccess", "TRUE" },
		{ "Category", "CoreInteractionProgressWidget" },
		{ "ModuleRelativePath", "Public/CoreInteractionProgressWidget.h" },
	};
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UCoreInteractionProgressWidget_Statics::NewProp__hemorrhageAnimationIsCompleteDelegate = { "_hemorrhageAnimationIsCompleteDelegate", nullptr, (EPropertyFlags)0x0040000010080005, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCoreInteractionProgressWidget, _hemorrhageAnimationIsCompleteDelegate), Z_Construct_UDelegateFunction_DBDUIViewInterfaces_OnHemorrhageAnimationCompleteEvent__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UCoreInteractionProgressWidget_Statics::NewProp__hemorrhageAnimationIsCompleteDelegate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCoreInteractionProgressWidget_Statics::NewProp__hemorrhageAnimationIsCompleteDelegate_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UCoreInteractionProgressWidget_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UCoreInteractionProgressWidget_Statics::NewProp__hemorrhageAnimationIsCompleteDelegate,
	};
	...
	IMPLEMENT_CLASS(UCoreInteractionProgressWidget, 3597721201);
