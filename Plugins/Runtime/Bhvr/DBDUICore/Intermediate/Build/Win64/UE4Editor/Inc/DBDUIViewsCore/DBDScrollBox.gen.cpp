...
// End Cross Module References
	...
	DEFINE_FUNCTION(UDBDScrollBox::execIsScrollBarNeeded)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(bool*)Z_Param__Result=P_THIS->IsScrollBarNeeded();
		P_NATIVE_END;
	}
	...
	DEFINE_FUNCTION(UDBDScrollBox::execSetDisplayPrompt)
	{
		P_GET_OBJECT(UCoreKeyListenerInputPromptWidget,Z_Param_displayPrompt);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->SetDisplayPrompt(Z_Param_displayPrompt);
		P_NATIVE_END;
	}
	...
	DEFINE_FUNCTION(UDBDScrollBox::execUpdateSmoothMask)
	{
		P_GET_PROPERTY(FFloatProperty,Z_Param_currentOffset);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->UpdateSmoothMask(Z_Param_currentOffset);
		P_NATIVE_END;
	}
	void UDBDScrollBox::StaticRegisterNativesUDBDScrollBox()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "IsScrollBarNeeded", &UDBDScrollBox::execIsScrollBarNeeded },
			{ "OnControlModeChanged", &UDBDScrollBox::execOnControlModeChanged },
			{ "SetDisplayPrompt", &UDBDScrollBox::execSetDisplayPrompt },
			{ "UpdateDisplayPrompt", &UDBDScrollBox::execUpdateDisplayPrompt },
			{ "UpdateSmoothMask", &UDBDScrollBox::execUpdateSmoothMask },
		};
	...
	struct Z_Construct_UFunction_UDBDScrollBox_IsScrollBarNeeded_Statics
	{
		struct DBDScrollBox_eventIsScrollBarNeeded_Parms
		{
			bool ReturnValue;
		};
		static void NewProp_ReturnValue_SetBit(void* Obj);
	...
	void Z_Construct_UFunction_UDBDScrollBox_IsScrollBarNeeded_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
		((DBDScrollBox_eventIsScrollBarNeeded_Parms*)Obj)->ReturnValue = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UDBDScrollBox_IsScrollBarNeeded_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(DBDScrollBox_eventIsScrollBarNeeded_Parms), &Z_Construct_UFunction_UDBDScrollBox_IsScrollBarNeeded_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UDBDScrollBox_IsScrollBarNeeded_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UDBDScrollBox_IsScrollBarNeeded_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UDBDScrollBox_IsScrollBarNeeded_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/DBDScrollBox.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UDBDScrollBox_IsScrollBarNeeded_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDBDScrollBox, nullptr, "IsScrollBarNeeded", nullptr, nullptr, sizeof(DBDScrollBox_eventIsScrollBarNeeded_Parms), Z_Construct_UFunction_UDBDScrollBox_IsScrollBarNeeded_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDBDScrollBox_IsScrollBarNeeded_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UDBDScrollBox_IsScrollBarNeeded_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UDBDScrollBox_IsScrollBarNeeded_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UDBDScrollBox_IsScrollBarNeeded()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UDBDScrollBox_IsScrollBarNeeded_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_UDBDScrollBox_SetDisplayPrompt_Statics
	{
		struct DBDScrollBox_eventSetDisplayPrompt_Parms
		{
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UDBDScrollBox_SetDisplayPrompt_Statics::NewProp_displayPrompt_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UDBDScrollBox_SetDisplayPrompt_Statics::NewProp_displayPrompt = { "displayPrompt", nullptr, (EPropertyFlags)0x0010000000080080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(DBDScrollBox_eventSetDisplayPrompt_Parms, displayPrompt), Z_Construct_UClass_UCoreKeyListenerInputPromptWidget_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UDBDScrollBox_SetDisplayPrompt_Statics::NewProp_displayPrompt_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UDBDScrollBox_SetDisplayPrompt_Statics::NewProp_displayPrompt_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UDBDScrollBox_SetDisplayPrompt_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UDBDScrollBox_SetDisplayPrompt_Statics::NewProp_displayPrompt,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UDBDScrollBox_SetDisplayPrompt_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/DBDScrollBox.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UDBDScrollBox_SetDisplayPrompt_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDBDScrollBox, nullptr, "SetDisplayPrompt", nullptr, nullptr, sizeof(DBDScrollBox_eventSetDisplayPrompt_Parms), Z_Construct_UFunction_UDBDScrollBox_SetDisplayPrompt_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDBDScrollBox_SetDisplayPrompt_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UDBDScrollBox_SetDisplayPrompt_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UDBDScrollBox_SetDisplayPrompt_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UDBDScrollBox_SetDisplayPrompt()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UDBDScrollBox_SetDisplayPrompt_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_UDBDScrollBox_UpdateSmoothMask_Statics
	{
		struct DBDScrollBox_eventUpdateSmoothMask_Parms
		{
			float currentOffset;
		};
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UDBDScrollBox_UpdateSmoothMask_Statics::NewProp_currentOffset = { "currentOffset", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(DBDScrollBox_eventUpdateSmoothMask_Parms, currentOffset), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UDBDScrollBox_UpdateSmoothMask_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UDBDScrollBox_UpdateSmoothMask_Statics::NewProp_currentOffset,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UDBDScrollBox_UpdateSmoothMask_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/DBDScrollBox.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UDBDScrollBox_UpdateSmoothMask_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDBDScrollBox, nullptr, "UpdateSmoothMask", nullptr, nullptr, sizeof(DBDScrollBox_eventUpdateSmoothMask_Parms), Z_Construct_UFunction_UDBDScrollBox_UpdateSmoothMask_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDBDScrollBox_UpdateSmoothMask_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04040401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UDBDScrollBox_UpdateSmoothMask_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UDBDScrollBox_UpdateSmoothMask_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UDBDScrollBox_UpdateSmoothMask()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UDBDScrollBox_UpdateSmoothMask_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_IsUsingSmoothMask_MetaData[];
#endif
		static void NewProp_IsUsingSmoothMask_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_IsUsingSmoothMask;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_SmoothMaskRetainerBox_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_SmoothMaskRetainerBox;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UDBDScrollBox_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UDBDScrollBox_IsScrollBarNeeded, "IsScrollBarNeeded" }, // 3924802426
		{ &Z_Construct_UFunction_UDBDScrollBox_OnControlModeChanged, "OnControlModeChanged" }, // 683012974
		{ &Z_Construct_UFunction_UDBDScrollBox_SetDisplayPrompt, "SetDisplayPrompt" }, // 3927701955
		{ &Z_Construct_UFunction_UDBDScrollBox_UpdateDisplayPrompt, "UpdateDisplayPrompt" }, // 280740537
		{ &Z_Construct_UFunction_UDBDScrollBox_UpdateSmoothMask, "UpdateSmoothMask" }, // 3010556346
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDBDScrollBox_Statics::NewProp__useControllerScroll = { "_useControllerScroll", nullptr, (EPropertyFlags)0x0020080002000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UDBDScrollBox), &Z_Construct_UClass_UDBDScrollBox_Statics::NewProp__useControllerScroll_SetBit, METADATA_PARAMS(Z_Construct_UClass_UDBDScrollBox_Statics::NewProp__useControllerScroll_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDBDScrollBox_Statics::NewProp__useControllerScroll_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDBDScrollBox_Statics::NewProp__shouldScrollOnMouseOver = { "_shouldScrollOnMouseOver", nullptr, (EPropertyFlags)0x0020080002000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UDBDScrollBox), &Z_Construct_UClass_UDBDScrollBox_Statics::NewProp__shouldScrollOnMouseOver_SetBit, METADATA_PARAMS(Z_Construct_UClass_UDBDScrollBox_Statics::NewProp__shouldScrollOnMouseOver_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDBDScrollBox_Statics::NewProp__shouldScrollOnMouseOver_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDBDScrollBox_Statics::NewProp__scrollSpeed = { "_scrollSpeed", nullptr, (EPropertyFlags)0x0020080002000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDBDScrollBox, _scrollSpeed), METADATA_PARAMS(Z_Construct_UClass_UDBDScrollBox_Statics::NewProp__scrollSpeed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDBDScrollBox_Statics::NewProp__scrollSpeed_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UDBDScrollBox_Statics::NewProp__displayPrompt = { "_displayPrompt", nullptr, (EPropertyFlags)0x002008000208000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDBDScrollBox, _displayPrompt), Z_Construct_UClass_UCoreKeyListenerInputPromptWidget_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UDBDScrollBox_Statics::NewProp__displayPrompt_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDBDScrollBox_Statics::NewProp__displayPrompt_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FTextPropertyParams Z_Construct_UClass_UDBDScrollBox_Statics::NewProp__displayPromptText = { "_displayPromptText", nullptr, (EPropertyFlags)0x0020080002000005, UE4CodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDBDScrollBox, _displayPromptText), METADATA_PARAMS(Z_Construct_UClass_UDBDScrollBox_Statics::NewProp__displayPromptText_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDBDScrollBox_Statics::NewProp__displayPromptText_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UDBDScrollBox_Statics::NewProp__showDisplayPrompt = { "_showDisplayPrompt", nullptr, (EPropertyFlags)0x0020080002000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDBDScrollBox, _showDisplayPrompt), Z_Construct_UEnum_DBDUIViewsCore_EShowScrollDisplayPrompt, METADATA_PARAMS(Z_Construct_UClass_UDBDScrollBox_Statics::NewProp__showDisplayPrompt_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDBDScrollBox_Statics::NewProp__showDisplayPrompt_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDBDScrollBox_Statics::NewProp_IsUsingSmoothMask_MetaData[] = {
		{ "Category", "DBDScrollBox" },
		{ "ModuleRelativePath", "Public/DBDScrollBox.h" },
	};
#endif
	void Z_Construct_UClass_UDBDScrollBox_Statics::NewProp_IsUsingSmoothMask_SetBit(void* Obj)
	{
		((UDBDScrollBox*)Obj)->IsUsingSmoothMask = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDBDScrollBox_Statics::NewProp_IsUsingSmoothMask = { "IsUsingSmoothMask", nullptr, (EPropertyFlags)0x0020080002000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UDBDScrollBox), &Z_Construct_UClass_UDBDScrollBox_Statics::NewProp_IsUsingSmoothMask_SetBit, METADATA_PARAMS(Z_Construct_UClass_UDBDScrollBox_Statics::NewProp_IsUsingSmoothMask_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDBDScrollBox_Statics::NewProp_IsUsingSmoothMask_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDBDScrollBox_Statics::NewProp_SmoothMaskRetainerBox_MetaData[] = {
		{ "BindWidget", "" },
		{ "Category", "DBDScrollBox" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/DBDScrollBox.h" },
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UDBDScrollBox_Statics::NewProp_SmoothMaskRetainerBox = { "SmoothMaskRetainerBox", nullptr, (EPropertyFlags)0x002008000208000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDBDScrollBox, SmoothMaskRetainerBox), Z_Construct_UClass_URetainerBox_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UDBDScrollBox_Statics::NewProp_SmoothMaskRetainerBox_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDBDScrollBox_Statics::NewProp_SmoothMaskRetainerBox_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UDBDScrollBox_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDBDScrollBox_Statics::NewProp_IsUsingSmoothMask,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDBDScrollBox_Statics::NewProp_SmoothMaskRetainerBox,
	};
	...
	IMPLEMENT_CLASS(UDBDScrollBox, 395746314);
